...
if (isloggedin()) {
    ...
    redirect($CFG->wwwroot . '/course/index.php?categoryid=11');
}
...
<div class="container">
  ...
  <div class="form-row">
    <div class="col-md-5">
        <br>
        <h2>Falls Sie bereits ein Nutzerkonto für die Internationale DAAD Akademie haben, tragen Sie Ihre Zugangsdaten ein.</h2>
    ...
    <div class="col-md-5">
        <br>
        <h2>Falls Sie noch nicht registriert sind, können Sie hier ein Nutzerkonto anlegen.<h2>
