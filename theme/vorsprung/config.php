...
// This is a critical setting. We want to inherit from theme_boost_vorsprung because it provides a great starting point for SCSS bootstrap4
...
$THEME->parents = ['boost_vorsprung'];

// A dock is a way to take blocks out of the page and put them in a persistent floating area on the side of the page. Boost Vorsprung
// does not support a dock so we won't either - but look at bootstrapbase for an example of a theme with a dock.
$THEME->enable_dock = false;

// This is an old setting used to load specific CSS for some YUI JS. We don't need it in Boost Vorsprung based themes because Boost Vorsprung
...
// pages in Moodle. Boost Vorsprung does not require these blocks because it provides other ways to navigate built into the theme.
$THEME->requiredblocks = '';

// This is a feature that tells the blocks library not to use the "Add a block" block. We don't want this in boost_vorsprung based themes because
// it forces a block region into the page when editing is enabled and it takes up too much room.
$THEME->addblockposition = BLOCK_ADDBLOCK_POSITION_FLATNAV;
$THEME->haseditswitch = true;
$THEME->scss = function($theme) {
    return theme_vorsprung_get_main_scss_content($theme);
};

$THEME->csspostprocess = 'theme_vorsprung_process_css';
