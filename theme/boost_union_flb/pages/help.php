...
// Set page URL.
$PAGE->set_url('/theme/boost_union_flb/pages/help.php');
...
$PAGE->add_body_class('theme_boost_union_flb-help');
...
// Set page title.
$PAGE->set_title(theme_boost_union_flb_get_staticpage_pagetitle('help'));

// Start page output.
echo $OUTPUT->header();

// Show page heading.
echo $OUTPUT->heading(theme_boost_union_flb_get_staticpage_pagetitle('help'));
