...
// Set page URL.
$PAGE->set_url('/theme/boost_union_flb/pages/contact.php');
...
$PAGE->add_body_class('theme_boost_union_flb-contact');
...
if ($config->enablecontact != THEME_boost_union_flb_SETTING_SELECT_YES) {
    echo $OUTPUT->header();
    $notification = new \core\output\notification(get_string('contactdisabled', 'theme_boost_union_flb'),
...
// Set page title.
$PAGE->set_title(theme_boost_union_flb_get_staticpage_pagetitle('contact'));

// Start page output.
echo $OUTPUT->header();

// Show page heading.
echo $OUTPUT->heading(theme_boost_union_flb_get_staticpage_pagetitle('contact'));
