...
// Set page URL.
$PAGE->set_url('/theme/boost_union_flb/pages/maintenance.php');
...
$PAGE->add_body_class('theme_boost_union_flb-maintenance');
...
if ($config->enablemaintenance != THEME_BOOST_UNION_FLB_SETTING_SELECT_YES) {
    echo $OUTPUT->header();
    $notification = new \core\output\notification(get_string('maintenancedisabled', 'theme_boost_union_flb'),
...
// Set page title.
$PAGE->set_title(theme_boost_union_flb_get_staticpage_pagetitle('maintenance'));

// Start page output.
echo $OUTPUT->header();

// Show page heading.
echo $OUTPUT->heading(theme_boost_union_flb_get_staticpage_pagetitle('maintenance'));
