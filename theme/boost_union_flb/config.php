...
/**
 * Theme Boost Union FlB - Theme config
 *
...
// This move will save us from duplicating all lines from Boost Union's config.php into Boost Union FlB's config.php.
...
// Then, we require Boost Union FlB's locallib.php to make sure that it's always loaded.
require_once($CFG->dirroot . '/theme/boost_union_flb/locallib.php');

// Next, we overwrite only the settings which differ between Boost Union and Boost Union FlB.
...
// Lastly, we replicate some settings from Boost Union at runtime into Boost Union FlB's settings.
...
// it would be quite ugly to duplicate all of these settings again to Boost Union FlB.
