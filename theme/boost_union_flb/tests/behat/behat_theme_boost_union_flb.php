...
/**
 * Class behat_theme_boost_union_flb
 *
 * @package    theme_boost_union_flb
 * @copyright  2022 Alexander Bias, lern.link GmbH <alexander.bias@lernlink.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_boost_union_flb extends behat_base {
    /**
     * Scroll the page.
     *
    ...
    public function i_am_on_imprint_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_flb/pages/imprint.php']);
    }
    ...
    public function i_am_on_contact_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_flb/pages/contact.php']);
    }
    ...
    public function i_am_on_help_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_flb/pages/help.php']);
    }
    ...
    public function i_am_on_maintenance_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_flb/pages/maintenance.php']);
    }
}
