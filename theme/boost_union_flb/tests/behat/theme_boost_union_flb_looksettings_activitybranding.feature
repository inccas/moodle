@theme @theme_boost_union_flb @theme_boost_union_flb_looksettings @theme_boost_union_flb_looksettings_activitybranding
Feature: Configuring the theme_boost_union_flb plugin for the "Activity branding" tab on the "Look" page
  ...
  Scenario Outline: Setting: Custom icons files - Upload custom icons files
    Given the following config values are set as admin:
      | config         | value | plugin            |
      | modiconsenable | yes   | theme_boost_union_flb |
    ...
    And I upload "theme/boost_union_flb/tests/fixtures/<iconfile>" file to "Custom icons files" filemanager
