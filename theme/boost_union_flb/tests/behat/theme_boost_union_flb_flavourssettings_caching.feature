@theme @theme_boost_union_flb @theme_boost_union_flb_flavourssettings @theme_boost_union_flb_flavourssettings_caching
Feature: Configuring the theme_boost_union_flb plugin on the "Flavours" page, caching the flavours which apply
