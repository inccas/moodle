@theme @theme_boost_union_flb @theme_boost_union_flb_looksettings @theme_boost_union_flb_looksettings_page
Feature: Configuring the theme_boost_union_flb plugin for the "Page" tab on the "Look" page
