 ...
 * * Render theme_boost_union_flb/columns2 instead of theme_boost/columns2 template
...
// Render columns2.mustache from boost_union_flb.
echo $OUTPUT->render_from_template('theme_boost_union_flb/columns2', $templatecontext);
