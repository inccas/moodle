...
if (isloggedin()) {
    ...
    if (isguestuser()) {
        $sitehomerighthandblockdrawerserverconfig = get_config('theme_boost_union_flb', 'showsitehomerighthandblockdraweronguestlogin');
    } else {
...
if (defined('BEHAT_SITE_RUNNING')) {
    try {
        if (
            ...
            get_config('theme_boost_union_flb', 'showsitehomerighthandblockdraweronguestlogin') === false &&
            get_config('theme_boost_union_flb', 'showsitehomerighthandblockdraweronfirstlogin') === false
        ) {
            $blockdraweropen = true;
        }
    } catch (Exception $e) {
