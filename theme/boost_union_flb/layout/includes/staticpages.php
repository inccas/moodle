...
foreach ($staticpages as $staticpage) {
    ...
    if ($config->{'enable'.$staticpage} == THEME_boost_union_flb_SETTING_SELECT_YES) {
        ...
        if ($config->{$staticpage.'linkposition'} == THEME_boost_union_flb_SETTING_STATICPAGELINKPOSITION_FOOTNOTE ||
                $config->{$staticpage.'linkposition'} == THEME_boost_union_flb_SETTING_STATICPAGELINKPOSITION_BOTH) {
        ...
        if ($config->{$staticpage.'linkposition'} == THEME_boost_union_flb_SETTING_STATICPAGELINKPOSITION_FOOTER ||
                $config->{$staticpage.'linkposition'} == THEME_boost_union_flb_SETTING_STATICPAGELINKPOSITION_BOTH) {
        ...
        $templatecontext[$staticpage.'link'] = theme_boost_union_flb_get_staticpage_link($staticpage);
        $templatecontext[$staticpage.'pagetitle'] = theme_boost_union_flb_get_staticpage_pagetitle($staticpage);
    }
}
