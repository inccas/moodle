 ...
 * * Render theme_boost_union_flb/login instead of theme_boost/login template
 * * Include footnote
...
list($loginbackgroundimagetext, $loginbackgroundimagetextcolor) = theme_boost_union_flb_get_loginbackgroundimage_text();
...
$templatecontext = [
    ...
    'loginwrapperclass' => 'login-wrapper-'.get_config('theme_boost_union_flb', 'loginformposition'),
    'logincontainerclass' =>
            (get_config('theme_boost_union_flb', 'loginformtransparency') == THEME_boost_union_flb_SETTING_SELECT_YES) ?
                    'login-container-80t' : ''
];
...
// Render login.mustache from boost_union_flb.
echo $OUTPUT->render_from_template('theme_boost_union_flb/login', $templatecontext);
