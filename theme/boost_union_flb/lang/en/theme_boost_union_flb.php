...
$string['emailbrandinginstructionli2'] = 'Search for and modify these strings in the <code>theme_boost_union_flb language</code> pack:';
...
// Capabilities.
$string['boost_union_flb:configure'] = 'To be able to configure the theme as non-admin';
$string['boost_union_flb:viewhintcourseselfenrol'] = 'To be able to see a hint for unrestricted self enrolment in a visible course.';
$string['boost_union_flb:viewhintinhiddencourse'] = 'To be able to see a hint in a hidden course.';
$string['boost_union_flb:viewregionheader'] = 'To be able to see the Header block region';
$string['boost_union_flb:editregionheader'] = 'To be able to edit the Header block region';
$string['boost_union_flb:viewregionoutsideleft'] = 'To be able to see the Outside (left) block region';
$string['boost_union_flb:editregionoutsideleft'] = 'To be able to edit the Outside (left) block region';
$string['boost_union_flb:viewregionoutsideright'] = 'To be able to see the Outside (right) block region';
$string['boost_union_flb:editregionoutsideright'] = 'To be able to edit the Outside (right) block region';
$string['boost_union_flb:viewregionoutsidetop'] = 'To be able to see the Outside (top) block region';
$string['boost_union_flb:editregionoutsidetop'] = 'To be able to edit the Outside (top) block region';
$string['boost_union_flb:viewregionoutsidebottom'] = 'To be able to see the Outside (bottom) block region';
$string['boost_union_flb:editregionoutsidebottom'] = 'To be able to edit the Outside (bottom) block region';
$string['boost_union_flb:viewregioncontentupper'] = 'To be able to see the Content (upper) block region';
$string['boost_union_flb:editregioncontentupper'] = 'To be able to edit the Content (upper) block region';
$string['boost_union_flb:viewregioncontentlower'] = 'To be able to see the Content (lower) block region';
$string['boost_union_flb:editregioncontentlower'] = 'To be able to edit the Content (lower) block region';
$string['boost_union_flb:viewregionfooterleft'] = 'To be able to see the Footer (left) block region';
$string['boost_union_flb:editregionfooterleft'] = 'To be able to edit the Footer (left) block region';
$string['boost_union_flb:viewregionfooterright'] = 'To be able to see the Footer (right) block region';
$string['boost_union_flb:editregionfooterright'] = 'To be able to edit the Footer (right) block region';
$string['boost_union_flb:viewregionfootercenter'] = 'To be able to see the Footer (center) block region';
$string['boost_union_flb:editregionfootercenter'] = 'To be able to edit the Footer (center) block region';
$string['boost_union_flb:viewregionoffcanvasleft'] = 'To be able to see the Off-canvas (left) block region';
$string['boost_union_flb:editregionoffcanvasleft'] = 'To be able to edit the Off-canvas (left) block region';
$string['boost_union_flb:viewregionoffcanvasright'] = 'To be able to see the Off-canvas (right) block region';
$string['boost_union_flb:editregionoffcanvasright'] = 'To be able to edit the Off-canvas (right) block region';
$string['boost_union_flb:viewregionoffcanvascenter'] = 'To be able to see the Off-canvas (center) block region';
$string['boost_union_flb:editregionoffcanvascenter'] = 'To be able to edit the Off-canvas (center) block region';
