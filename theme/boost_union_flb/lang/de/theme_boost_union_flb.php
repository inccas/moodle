...
/**
 * Theme Boost Union FlB - Sprachpaket
 *
...
$string['choosereadme'] = 'Dieses Plugin ist nur eine Standardvorlage, die man zum Entwickeln von Boost Union-Child-Themes verwenden kann.';
$string['configtitle'] = 'Boost Union FlB';
$string['settingsoverview_buc_desc'] = 'Mit Boost Union FlB können Sie Boost Union an Ihre eigenen lokalen Bedürfnisse anpassen.';
...
$string['inheritanceoptionsexplanation'] = 'In den meisten Fällen ist die Vererbung vollkommen in Ordnung. Es kann jedoch vorkommen, dass fehlerhafter Code in Boost Union integriert wird, der eine einfache SCSS-Vererbung für bestimmte Boost Union-Funktionen verhindert. Wenn Sie auf Probleme mit Boost Union-Funktionen stoßen, die auch in Boost Union FlB nicht zu funktionieren scheinen, versuchen Sie, diese Einstellung auf \'Duplizieren\' zu ändern und, wenn das Problem dadurch gelöst wird, melden Sie das Problem auf Github (Informationen zum Melden eines Problems finden Sie in der Datei README.md).';
...
// Datenschutz-API.
$string['privacy:metadata'] = 'Das Boost Union FlB-Design speichert keine persönlichen Daten über Benutzer.';