...
namespace theme_boost_union_flb\output\core_course\management;
...
class renderer extends \core_course_management_renderer {
    ...
    public function course_listitem_actions(core_course_category $category, core_course_list_element $course) {
        ...
        if (get_config('theme_boost_union_flb', 'showviewcourseiconincoursemgnt') == THEME_BOOST_UNION_FLB_SETTING_SELECT_YES) {
