@theme @theme_boost_union_flb @theme_boost_union_flb_looksettings @theme_boost_union_flb_looksettings_resources
Feature: Configuring the theme_boost_union_flb plugin for the "Resources" tab on the "Look" page
  ...
  Scenario: Setting: Additional resources - Upload additional resources files
    ...
    And I upload "theme/boost_union_flb/tests/fixtures/login_bg1.jpg" file to "Additional resources" filemanager
    ...
    And I should see "/pluginfile.php/1/theme_boost_union_flb/additionalresources/0/login_bg1.jpg" in the ".settings-additionalresources-filelist" "css_element"
  ...
  Scenario: Setting: Custom fonts - Upload custom fonts files
    ...
    And I navigate to "Appearance > Boost Union > Look" in site administration
    And I click on "Resources" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_flb/tests/fixtures/roboto-v30-latin-regular.woff" file to "Custom fonts" filemanager
    And I press "Save changes"
    And I navigate to "Appearance > Boost Union > Look" in site administration
    And I click on "Resources" "link" in the "#adminsettings .nav-tabs" "css_element"
    ...
    And I should see "/pluginfile.php/1/theme_boost_union_flb/customfonts/0/roboto-v30-latin-regular.woff" in the ".settings-customfonts-filelist" "css_element"
  ...
  Scenario: Setting: FontAwesome - Do not upload any file (countercheck)
    When I log in as "admin"
    Then "head > link[rel='stylesheet'][href~='theme_boost_union_flb/fontawesome']" "css_element" should not exist
    And I navigate to "Appearance > Boost Union > Look" in site administration
    And I click on "Resources" "link" in the "#adminsettings .nav-tabs" "css_element"
