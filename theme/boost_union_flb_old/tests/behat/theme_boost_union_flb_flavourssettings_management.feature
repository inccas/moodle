@theme @theme_boost_union_flb @theme_boost_union_flb_flavourssettings @theme_boost_union_flb_flavourssettings_management
Feature: Configuring the theme_boost_union_flb plugin on the "Flavours" page, managing the individual flavours
