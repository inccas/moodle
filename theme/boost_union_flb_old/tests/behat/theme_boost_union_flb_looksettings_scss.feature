@theme @theme_boost_union_flb @theme_boost_union_flb_looksettings @theme_boost_union_flb_looksettings_scss
Feature: Configuring the theme_boost_union_flb plugin for the "SCSS" tab on the "Look" page
