@theme @theme_boost_union_ida @theme_boost_union_ida_looksettings @theme_boost_union_ida_looksettings_page
Feature: Configuring the theme_boost_union_ida plugin for the "Page" tab on the "Look" page
