...
/**
 * Class behat_theme_boost_union_ida
 *
 * @package    theme_boost_union_ida
 * @copyright  2022 Alexander Bias, lern.link GmbH <alexander.bias@lernlink.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_boost_union_ida extends behat_base {
    /**
     * Scroll the page.
     *
    ...
    public function i_am_on_imprint_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_ida/pages/imprint.php']);
    }
    ...
    public function i_am_on_contact_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_ida/pages/contact.php']);
    }
    ...
    public function i_am_on_help_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_ida/pages/help.php']);
    }
    ...
    public function i_am_on_maintenance_page() {
        $this->execute('behat_general::i_visit', ['/theme/boost_union_ida/pages/maintenance.php']);
    }
}
