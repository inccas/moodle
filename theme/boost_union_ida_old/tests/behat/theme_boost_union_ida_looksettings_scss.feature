@theme @theme_boost_union_ida @theme_boost_union_ida_looksettings @theme_boost_union_ida_looksettings_scss
Feature: Configuring the theme_boost_union_ida plugin for the "SCSS" tab on the "Look" page
