@theme @theme_boost_union_ida @theme_boost_union_ida_managers
Feature: Configuring the theme_boost_union_ida plugin as manager
  ...
  Scenario: Capabilities - Allow managers to configure Boost Union
    Given the following "permission overrides" exist:
      ...
      | theme/boost_union_ida:configure | Allow      | manager | System       |           |
    ...
    And "body#page-admin-setting-theme_boost_union_ida_look" "css_element" should exist
    ...
    And "body#page-admin-theme-boost_union_ida-flavours-overview" "css_element" should exist
  ...
  Scenario: Capabilities - Do not allow managers to configure Boost Union (countercheck)
    Given the following "permission overrides" exist:
      | capability                  | permission | role    | contextlevel | reference |
      | theme/boost_union_ida:configure | Prevent    | manager | System       |           |
    And I log in as "manager"
    And I follow "Site administration"
