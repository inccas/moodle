@theme @theme_boost_union_ida @theme_boost_union_ida_looksettings @theme_boost_union_ida_looksettings_h5p
Feature: Configuring the theme_boost_union_ida plugin for the "H5P" tab on the "Look" page
