@theme @theme_boost_union_ida @theme_boost_union_ida_looksettings @theme_boost_union_ida_looksettings_activitybranding
Feature: Configuring the theme_boost_union_ida plugin for the "Activity branding" tab on the "Look" page
  ...
  Scenario Outline: Setting: Custom icons files - Upload custom icons files
    Given the following config values are set as admin:
      | config         | value | plugin            |
      | modiconsenable | yes   | theme_boost_union_ida |
    ...
    And I upload "theme/boost_union_ida/tests/fixtures/<iconfile>" file to "Custom icons files" filemanager
