...
// General.
$string['pluginname'] = 'Boost Union iDA';
$string['choosereadme'] = '<p>Boost Union Child Theme is a child theme of Boost.</p>';
$string['configtitle'] = 'Boost Union iDA';
...
$string['emailbrandinginstructionli2'] = 'Search for and modify these strings in the <code>theme_boost_union_ida language</code> pack:';
...
// Capabilities.
$string['boost_union_ida:configure'] = 'To be able to configure the theme as non-admin';
$string['boost_union_ida:viewhintcourseselfenrol'] = 'To be able to see a hint for unrestricted self enrolment in a visible course.';
$string['boost_union_ida:viewhintinhiddencourse'] = 'To be able to see a hint in a hidden course.';
$string['boost_union_ida:viewregionheader'] = 'To be able to see the Header block region';
$string['boost_union_ida:editregionheader'] = 'To be able to edit the Header block region';
$string['boost_union_ida:viewregionoutsideleft'] = 'To be able to see the Outside (left) block region';
$string['boost_union_ida:editregionoutsideleft'] = 'To be able to edit the Outside (left) block region';
$string['boost_union_ida:viewregionoutsideright'] = 'To be able to see the Outside (right) block region';
$string['boost_union_ida:editregionoutsideright'] = 'To be able to edit the Outside (right) block region';
$string['boost_union_ida:viewregionoutsidetop'] = 'To be able to see the Outside (top) block region';
$string['boost_union_ida:editregionoutsidetop'] = 'To be able to edit the Outside (top) block region';
$string['boost_union_ida:viewregionoutsidebottom'] = 'To be able to see the Outside (bottom) block region';
$string['boost_union_ida:editregionoutsidebottom'] = 'To be able to edit the Outside (bottom) block region';
$string['boost_union_ida:viewregioncontentupper'] = 'To be able to see the Content (upper) block region';
$string['boost_union_ida:editregioncontentupper'] = 'To be able to edit the Content (upper) block region';
$string['boost_union_ida:viewregioncontentlower'] = 'To be able to see the Content (lower) block region';
$string['boost_union_ida:editregioncontentlower'] = 'To be able to edit the Content (lower) block region';
$string['boost_union_ida:viewregionfooterleft'] = 'To be able to see the Footer (left) block region';
$string['boost_union_ida:editregionfooterleft'] = 'To be able to edit the Footer (left) block region';
$string['boost_union_ida:viewregionfooterright'] = 'To be able to see the Footer (right) block region';
$string['boost_union_ida:editregionfooterright'] = 'To be able to edit the Footer (right) block region';
$string['boost_union_ida:viewregionfootercenter'] = 'To be able to see the Footer (center) block region';
$string['boost_union_ida:editregionfootercenter'] = 'To be able to edit the Footer (center) block region';
$string['boost_union_ida:viewregionoffcanvasleft'] = 'To be able to see the Off-canvas (left) block region';
$string['boost_union_ida:editregionoffcanvasleft'] = 'To be able to edit the Off-canvas (left) block region';
$string['boost_union_ida:viewregionoffcanvasright'] = 'To be able to see the Off-canvas (right) block region';
$string['boost_union_ida:editregionoffcanvasright'] = 'To be able to edit the Off-canvas (right) block region';
$string['boost_union_ida:viewregionoffcanvascenter'] = 'To be able to see the Off-canvas (center) block region';
$string['boost_union_ida:editregionoffcanvascenter'] = 'To be able to edit the Off-canvas (center) block region';
