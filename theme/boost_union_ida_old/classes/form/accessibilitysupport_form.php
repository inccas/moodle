...
class accessibilitysupport_form extends \moodleform {
    ...
    public function definition(): void {
        ...
        if (isset($sendanonymoussetting) && $sendanonymoussetting == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES && isloggedin()
                && !isguestuser()) {
        ...
        if (isset($enablesendtechinfo) && $enablesendtechinfo == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
