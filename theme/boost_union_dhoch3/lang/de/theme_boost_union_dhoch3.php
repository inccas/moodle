...
/**
 * Theme Boost Union DHoch3 - Sprachpaket
 *
...
$string['choosereadme'] = 'Dieses Plugin ist nur eine Standardvorlage, die zum Entwickeln von Boost Union-Child-Themes verwendet werden kann.';
$string['configtitle'] = 'Boost Union DHoch3';
$string['settingsoverview_buc_desc'] = 'Mit Boost Union DHoch3 können Sie Boost Union an Ihre eigenen lokalen Anforderungen anpassen.';

// Einstellungen: Registerkarte „Allgemeine Einstellungen“.
// ... Abschnitt: Vererbung.
$string['inheritanceheading'] = 'Vererbung';
$string['inheritanceinherit'] = 'Vererbung';
$string['inheritanceduplicate'] = 'Duplizieren';
$string['inheritanceoptionsexplanation'] = 'In den meisten Fällen funktioniert die Vererbung einwandfrei. Es kann jedoch vorkommen, dass in Boost Union fehlerhafter Code integriert wird, der eine einfache SCSS-Vererbung für bestimmte Boost Union-Funktionen verhindert. Wenn Sie auf Probleme mit Boost Union-Funktionen stoßen, die auch in Boost Union DHoch3 nicht zu funktionieren scheinen, versuchen Sie, diese Einstellung auf \'Duplizieren\' umzustellen und, wenn das Problem dadurch gelöst wird, melden Sie das Problem auf Github (Informationen zum Melden eines Problems finden Sie in der Datei README.md).';
...
// Datenschutz-API.
$string['privacy:metadata'] = 'Das Boost Union DHoch3-Design speichert keine persönlichen Daten über Benutzer.';