...
/**
 * Theme Boost Union Dhoch3 - Language pack
 *
...
// General.
$string['pluginname'] = 'Boost Union Dhoch3';
$string['choosereadme'] = '<p>Theme Boost Union Dhoch3 is an enhanced child theme of Boost which is intended, on the one hand, to make Boost simply more configurable and, on the other hand, to provide helpful additional features for the daily Moodle operation of admins, teachers and students.</p><p>Boost Union Dhoch3 is maintained by<br />Moodle an Hochschulen e.V.,</p><p>in cooperation with<br />lern.link GmbH</p><p>together with<br />bdecent GmbH</p>';
$string['configtitle'] = 'Boost Union Dhoch3';
$string['githubissueslink'] = '<a href="https://github.com/moodle-an-hochschulen/moodle-theme_boost_union_dhoch3/issues">Github issues</a>';
...
$string['settingsoverview_title'] = 'Boost Union Dhoch3 settings overview';
...
$string['settingsoverview_all_desc'] = 'Here, you can open the standard Moodle category settings page for Boost Union Dhoch3 that shows all settings on one page. But beware, it is really packed.';
...
$string['presetheading_desc'] = 'Theme presets can be used to dramatically alter the appearance of the theme. Boost Union Dhoch3 does not re-implement the theme preset setting. If you want to use theme presets, please set them directly in Boost. Boost Union Dhoch3 will inherit and use the configured preset.';
...
$string['logosheading_desc'] = 'Please note: Boost Union Dhoch3 has its own logo upload and does not use the logo from <a href="{$a}">Moodle core\'s logo setting</a>.<br />Boost Union Dhoch3 especially allows you to upload more image formats that Moodle core allows and allows you to override the uploaded logos within its flavours.';
// ... ... Setting: Logo.
...
$string['faviconheading_desc'] = 'Please note: Boost Union Dhoch3 has its own favicon upload and does not use the favicon from <a href="{$a}">Moodle core\'s favicon setting</a>.<br />Boost Union Dhoch3 especially allows you to override the uploaded favicon within its flavours.';
// ... ... Setting: Favicon
...
$string['emailbrandinginstruction0'] = 'With this Boost Union Dhoch3 feature, you can apply branding to all E-Mails which Moodle is sending out.';
...
$string['emailbrandinginstructionli2'] = 'Search for and modify these strings in the <code>theme_boost_union_dhoch3</code> language pack:';
...
$string['mobilecss_set'] = 'As soon as you add any CSS code to this setting and save the setting, the <a href="{$a->url}">Moodle core setting <em>mobilecssurl</em></a> will be automatically set to a URL of the Boost Union Dhoch3 theme.';
$string['mobilecss_overwrite'] = 'As soon as you add any CSS code to this setting and save the setting, the <a href="{$a->url}">Moodle core setting <em>mobilecssurl</em></a> will be automatically overwritten with a URL of the Boost Union Dhoch3 theme. Currently this setting is set to <a href="{$a->value}">{$a->value}</a>.';
...
Please note: Here, you can just remove navigation nodes. But if you want to add custom navigation nodes, please consider using <a href="{$a->url}">Boost Union Dhoch3\'s smart menu functionality</a>.';
...
$string['blockregionsheading_desc'] = '<p>Boost Union Dhoch3 provides a large number of additional block regions which can be used to add and show blocks over the whole Moodle page:</p>
...
$string['blockregionoutsideleftwidth_desc'] = 'With this setting, you can set the width of the \'Outside (left)\' block region which is shown on the left hand side of the main content area. By default, Boost Union Dhoch3 uses a width of 300px. You can enter other pixel-based values like 200px, but you can also enter a percentage-based value like 10% or a viewport-width value like 10vw.';
...
$string['blockregionoutsiderightwidth_desc'] = 'With this setting, you can set the width of the \'Outside (right)\' block region which is shown on the right hand side of the main content area. By default, Boost Union Dhoch3 uses a width of 300px. You can enter other pixel-based values like 200px, but you can also enter a percentage-based value like 10% or a viewport-width value like 10vw.';
...
$string['markexternallinksscopesetting_desc'] = 'With this setting, you control the scope where Boost Union Dhoch3 should mark external links. By default, Boost Union Dhoch3 marks external links on the whole Moodle page and does its best to cover some edge-cases where adding the external link icon does not make much sense. However, you can also limit the scope to better avoid edge-cases.';
...
$string['markmailtolinksscopesetting_desc'] = 'With this setting, you control the scope where Boost Union Dhoch3 should mark mailto links. By default, Boost Union Dhoch3 marks mailto links on the whole Moodle page. However, you can also limit the scope to avoid edge-cases.';
...
$string['flavoursbackgroundimage_help'] = 'With this setting, the flavour will override the background image which is configured in Boost Union Dhoch3\'s look settings.';
...
$string['flavoursfavicon_help'] = 'With this setting, the flavour will override the favicon which is configured in Boost Union Dhoch3\'s look settings.';
...
$string['flavourslogo_help'] = 'With this setting, the flavour will override the logo which is configured in Boost Union Dhoch3\'s look settings.';
$string['flavourslogocompact'] = 'Compact logo';
$string['flavourslogocompact_help'] = 'With this setting, the flavour will override the logo which is configured in Boost Union Dhoch3\'s look settings.';
...
// Privacy API.
$string['privacy:metadata'] = 'The Boost Union Dhoch3 theme does not store any personal data about any user.';

// Capabilities.
$string['boost_union_dhoch3:configure'] = 'To be able to configure the theme as non-admin';
$string['boost_union_dhoch3:viewhintcourseselfenrol'] = 'To be able to see a hint for unrestricted self enrolment in a visible course.';
$string['boost_union_dhoch3:viewhintinhiddencourse'] = 'To be able to see a hint in a hidden course.';
$string['boost_union_dhoch3:viewregionheader'] = 'To be able to see the Header block region';
$string['boost_union_dhoch3:editregionheader'] = 'To be able to edit the Header block region';
$string['boost_union_dhoch3:viewregionoutsideleft'] = 'To be able to see the Outside (left) block region';
$string['boost_union_dhoch3:editregionoutsideleft'] = 'To be able to edit the Outside (left) block region';
$string['boost_union_dhoch3:viewregionoutsideright'] = 'To be able to see the Outside (right) block region';
$string['boost_union_dhoch3:editregionoutsideright'] = 'To be able to edit the Outside (right) block region';
$string['boost_union_dhoch3:viewregionoutsidetop'] = 'To be able to see the Outside (top) block region';
$string['boost_union_dhoch3:editregionoutsidetop'] = 'To be able to edit the Outside (top) block region';
$string['boost_union_dhoch3:viewregionoutsidebottom'] = 'To be able to see the Outside (bottom) block region';
$string['boost_union_dhoch3:editregionoutsidebottom'] = 'To be able to edit the Outside (bottom) block region';
$string['boost_union_dhoch3:viewregioncontentupper'] = 'To be able to see the Content (upper) block region';
$string['boost_union_dhoch3:editregioncontentupper'] = 'To be able to edit the Content (upper) block region';
$string['boost_union_dhoch3:viewregioncontentlower'] = 'To be able to see the Content (lower) block region';
$string['boost_union_dhoch3:editregioncontentlower'] = 'To be able to edit the Content (lower) block region';
$string['boost_union_dhoch3:viewregionfooterleft'] = 'To be able to see the Footer (left) block region';
$string['boost_union_dhoch3:editregionfooterleft'] = 'To be able to edit the Footer (left) block region';
$string['boost_union_dhoch3:viewregionfooterright'] = 'To be able to see the Footer (right) block region';
$string['boost_union_dhoch3:editregionfooterright'] = 'To be able to edit the Footer (right) block region';
$string['boost_union_dhoch3:viewregionfootercenter'] = 'To be able to see the Footer (center) block region';
$string['boost_union_dhoch3:editregionfootercenter'] = 'To be able to edit the Footer (center) block region';
$string['boost_union_dhoch3:viewregionoffcanvasleft'] = 'To be able to see the Off-canvas (left) block region';
$string['boost_union_dhoch3:editregionoffcanvasleft'] = 'To be able to edit the Off-canvas (left) block region';
$string['boost_union_dhoch3:viewregionoffcanvasright'] = 'To be able to see the Off-canvas (right) block region';
$string['boost_union_dhoch3:editregionoffcanvasright'] = 'To be able to edit the Off-canvas (right) block region';
$string['boost_union_dhoch3:viewregionoffcanvascenter'] = 'To be able to see the Off-canvas (center) block region';
$string['boost_union_dhoch3:editregionoffcanvascenter'] = 'To be able to edit the Off-canvas (center) block region';
...
// Upgrade notices.
$string['upgradenotice_2022080922'] = 'From this release on, Boost Union Dhoch3 has its own logo and compact logo settings and does not use these files from the Moodle core settings anymore.';
$string['upgradenotice_2022080922_logo'] = 'logo';
$string['upgradenotice_2022080922_logocompact'] = 'compact logo';
$string['upgradenotice_2022080922_copied'] = 'The existing <strong>{$a}</strong> from the Moodle core settings has been copied to the Boost Union Dhoch3 {$a} setting during this upgrade. Please double-check the result.';
$string['upgradenotice_2022080922_notcopied'] = 'The <strong>{$a}</strong> setting within Boost Union Dhoch3 is empty now. If you want to use a {$a} within Boost Union Dhoch3 from now on, just upload it into the Boost Union Dhoch3 {$a} setting later.';
