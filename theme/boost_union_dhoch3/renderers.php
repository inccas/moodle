...
/**
 * Boost Union Dhoch3 renderer class. This file is currently only used to extend the mod_h5p and mod_hvp renderers.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boost_union_dhoch3_core_h5p_renderer extends \core_h5p\output\renderer {
    ...
    public function h5p_alter_styles(&$styles, $libraries, $embedtype) {
        ...
        $h5pcssurl = new moodle_url('/theme/boost_union_dhoch3/h5p/styles.php');
...
if (file_exists($CFG->dirroot.'/mod/hvp/renderer.php')) {
    ...
    if (class_exists('mod_hvp_renderer')) {
         ...
         * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
         */
        class theme_boost_union_dhoch3_mod_hvp_renderer extends mod_hvp_renderer {
