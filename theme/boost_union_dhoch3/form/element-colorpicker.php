...
/**
 * Theme Boost Union Dhoch3 Login - Form element for color picker
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class moodlequickform_themeboostuniondhoch3_colorpicker extends MoodleQuickForm_text implements templatable {
    ...
    public function __construct($elementname=null, $elementlabel=null, $attributes=null) {
        ...
        $this->updateAttributes(['class' => $class.' theme_boost_union_dhoch3-form-colour-picker ']);
    }
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $PAGE->requires->js_amd_inline("
            ...
            element.parentNode.style.flexDirection = 'column'; // Helps to align the config text when
                                                               // theme_boost_union_dhoch3 is not the active theme.
