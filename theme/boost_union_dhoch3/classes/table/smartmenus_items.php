...
/**
 * Theme Boost Union Dhoch3 - Smart menu items overview table.
 *
...
namespace theme_boost_union_dhoch3\table;
...
class smartmenus_items extends \table_sql {
    ...
    public function __construct($menuid) {
        ...
        $headers[] = get_string('smartmenusmenuitemtitle', 'theme_boost_union_dhoch3');
        $headers[] = get_string('smartmenusmenuitemtype', 'theme_boost_union_dhoch3');
        $headers[] = get_string('smartmenusmenuitemrestriction', 'theme_boost_union_dhoch3');
        ...
        $this->count = 0;
        $this->totalmenuitems = $DB->count_records('theme_boost_union_dhoch3_menuitems');
    }
    ...
    public function col_type($data) {
        // Get the type.
        $type = \theme_boost_union_dhoch3\smartmenu_item::get_types($data->type);
    ...
    public function col_restrictions($data) {
        ...
        if ($data->roles != '' && !empty(json_decode($data->roles))) {
            ...
            // Amend rule list.
            $rules[] = [
                'name' => get_string('smartmenusbyrole', 'theme_boost_union_dhoch3'),
        ...
        if ($data->cohorts != '' && !empty(json_decode($data->cohorts))) {
            ...
            // Amend rule list.
            $rules[] = [
                'name' => get_string('smartmenusbycohort', 'theme_boost_union_dhoch3'),
        ...
        if ($data->languages != '' && !empty(json_decode($data->languages))) {
            ...
            // Amend rule list.
            $rules[] = [
                'name' => get_string('smartmenusbylanguage', 'theme_boost_union_dhoch3'),
        ...
        if ($data->start_date || $data->end_date) {
            ...
            if ($data->start_date) {
                $datelist[] = get_string('smartmenusbydatefrom', 'theme_boost_union_dhoch3').': '.
                        userdate($data->start_date, get_string('strftimedate', 'core_langconfig'));
            }

            // If we have end date restrictions.
            if ($data->end_date) {
                $datelist[] = get_string('smartmenusbydateuntil', 'theme_boost_union_dhoch3').': '.
            ...
            // Amend rule list.
            $rules[] = [
                    'name' => get_string('smartmenusbydate', 'theme_boost_union_dhoch3'),
        ...
        return $html ? $html : get_string('smartmenusnorestrict', 'theme_boost_union_dhoch3');
    }
    ...
    public function col_updown($data) {
        ...
        // Prepare action URL.
        $actionurl = new \moodle_url('/theme/boost_union_dhoch3/smartmenus/items.php');
    ...
    public function col_actions($data) {
        ...
        // Edit.
        $actions[] = [
            'url' => new \moodle_url('/theme/boost_union_dhoch3/smartmenus/edit_items.php',
        ...
        $actions[] = [
            ...
            'icon' => new \pix_icon('t/copy', get_string('smartmenusmenuitemduplicate', 'theme_boost_union_dhoch3')),
        ...
        $actions[] = [
            ...
            'confirm' => new \confirm_action(get_string('smartmenusmenuitemdeleteconfirm', 'theme_boost_union_dhoch3')),
        ];
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        ...
        $sql = 'SELECT *
                FROM {theme_boost_union_dhoch3_menuitems} t
                WHERE menu=:menuid
                ORDER BY sortorder';
    ...
    public function print_nothing_to_display() {
        ...
        $notification = new \core\output\notification(
                get_string('smartmenusmenuitemnothingtodisplay', 'theme_boost_union_dhoch3'),
