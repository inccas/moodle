...
/**
 * Theme Boost Union Dhoch3 - Smart menus overview table.
 *
...
class smartmenus_menus extends \table_sql {
    ...
    public function __construct() {
        ...
        $headers[] = get_string('smartmenusmenutitle', 'theme_boost_union_dhoch3');
        $headers[] = get_string('smartmenusmenudescription', 'theme_boost_union_dhoch3');
        $headers[] = get_string('smartmenusmenulocation', 'theme_boost_union_dhoch3');
        $headers[] = get_string('smartmenusmenutype', 'theme_boost_union_dhoch3');
        ...
        $this->count = 0;
        $this->totalmenus = $DB->count_records('theme_boost_union_dhoch3_menus');
    }
    ...
    public function col_location($data) {
        ...
        return (!empty($locations)) ? implode(' ', array_map(function($value) {
            $location = \theme_boost_union_dhoch3\smartmenu::get_location($value);
    ...
    public function col_type($data) {
        // Get the type.
        $type = \theme_boost_union_dhoch3\smartmenu::get_type($data->type);
    ...
    public function col_updown($data) {
        ...
        // Prepare action URL.
        $actionurl = new \moodle_url('/theme/boost_union_dhoch3/smartmenus/menus.php');
    ...
    public function col_actions($data) {
        ...
        // Edit.
        $actions[] = [
            'url' => new \moodle_url('/theme/boost_union_dhoch3/smartmenus/edit.php', ['id' => $data->id, 'sesskey' => sesskey()]),
        ...
        $actions[] = [
            ...
            'icon' => new \pix_icon('t/copy', get_string('smartmenusmenuduplicate', 'theme_boost_union_dhoch3')),
            'attributes' => ['class' => 'action-copy'],
        ];

        // List items.
        $actions[] = [
            'url' => new \moodle_url('/theme/boost_union_dhoch3/smartmenus/items.php', ['menu' => $data->id]),
        ...
        $actions[] = [
            ...
            'confirm' => new \confirm_action(get_string('smartmenusmenudeleteconfirm', 'theme_boost_union_dhoch3')),
        ];
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        ...
        $sql = 'SELECT *
                FROM {theme_boost_union_dhoch3_menus} t
                ORDER BY sortorder';
    ...
    public function print_nothing_to_display() {
        ...
        $notification = new \core\output\notification(
                get_string('smartmenusmenunothingtodisplay', 'theme_boost_union_dhoch3'),
