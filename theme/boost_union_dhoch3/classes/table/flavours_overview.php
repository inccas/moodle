...
/**
 * Theme Boost Union Dhoch3 - Flavours overview table
 *
...
class flavours_overview extends \table_sql {
    ...
    public function __construct() {
        ...
        $headers[] = get_string('flavourstitle', 'theme_boost_union_dhoch3');
        $headers[] = get_string('flavoursdescription', 'theme_boost_union_dhoch3');
        $headers[] = get_string('flavoursappliesto', 'theme_boost_union_dhoch3');
        ...
        $this->count = 0;
        $this->totalflavours = $DB->count_records('theme_boost_union_dhoch3_flavours');
    }
    ...
    public function col_updown($data) {
        ...
        // Prepare action URL.
        $actionurl = new \moodle_url('/theme/boost_union_dhoch3/flavours/overview.php');
    ...
    public function col_actions($data) {
        ...
        // Preview.
        $actions[] = [
                'url' => new \moodle_url('/theme/boost_union_dhoch3/flavours/preview.php', ['id' => $data->id]),
                'icon' => new \pix_icon('i/search', get_string('flavoursedit', 'theme_boost_union_dhoch3')),
                'attributes' => ['class' => 'action-preview'],
        ];

        // Edit.
        $actions[] = [
                'url' => new \moodle_url('/theme/boost_union_dhoch3/flavours/edit.php',
                        ['action' => 'edit', 'id' => $data->id, 'sesskey' => sesskey()]),
                'icon' => new \pix_icon('t/edit', get_string('flavoursedit', 'theme_boost_union_dhoch3')),
        ...
        $actions[] = [
                ...
                'icon' => new \pix_icon('t/delete', get_string('flavourspreview', 'theme_boost_union_dhoch3')),
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        ...
        $sql = 'SELECT *
                FROM {theme_boost_union_dhoch3_flavours} t
                ORDER BY sort';
    ...
    public function print_nothing_to_display() {
        ...
        $notification = new \core\output\notification(
                get_string('flavoursnothingtodisplay', 'theme_boost_union_dhoch3'), \core\output\notification::NOTIFY_INFO);
