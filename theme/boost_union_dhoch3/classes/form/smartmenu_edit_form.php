...
/**
 * Theme Boost Union Dhoch3 - Smart menu edit form
 *
...
class smartmenu_edit_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'title', get_string('smartmenusmenutitle', 'theme_boost_union_dhoch3'));
        $mform->setType('title', PARAM_TEXT);
        $mform->addRule('title', get_string('required'), 'required');
        $mform->addHelpButton('title', 'smartmenusmenutitle', 'theme_boost_union_dhoch3');

        // Add the description title as editor element.
        $mform->addElement('editor', 'description', get_string('smartmenusmenudescription', 'theme_boost_union_dhoch3'));
        $mform->setType('description', PARAM_CLEANHTML);
        $mform->addHelpButton('description', 'smartmenusmenudescription', 'theme_boost_union_dhoch3');

        // Add structure as header element.
        $mform->addElement('header', 'structureheader',
                get_string('smartmenusmenustructureheader', 'theme_boost_union_dhoch3'));
        $mform->setExpanded('structureheader');

        // Add locations as autocompletefield.
        $locationtypes = smartmenu::get_locations();
        $location = $mform->addElement('autocomplete', 'location', get_string('smartmenusmenulocation', 'theme_boost_union_dhoch3'),
                $locationtypes);
        $mform->addHelpButton('location', 'smartmenusmenulocation', 'theme_boost_union_dhoch3');
        $location->setMultiple(true);
        $mform->addRule('location', get_string('required'), 'required');

        // Add mode as select element.
        $modeoptions = [
                smartmenu::MODE_SUBMENU => get_string('smartmenusmodesubmenu', 'theme_boost_union_dhoch3'),
                smartmenu::MODE_INLINE => get_string('smartmenusmodeinline', 'theme_boost_union_dhoch3'),
        ];
        $mform->addElement('select', 'mode', get_string('smartmenusmenumode', 'theme_boost_union_dhoch3'), $modeoptions);
        $mform->setDefault('mode', smartmenu::MODE_SUBMENU);
        $mform->setType('mode', PARAM_INT);
        $mform->addHelpButton('mode', 'smartmenusmenumode', 'theme_boost_union_dhoch3');

        // Add presentation as header element.
        $mform->addElement('header', 'presentationheader',
                get_string('smartmenusmenupresentationheader', 'theme_boost_union_dhoch3'));
        $mform->setExpanded('presentationheader');

        // Add type as select element.
        $types = smartmenu::get_types();
        $mform->addElement('select', 'type', get_string('smartmenusmenutype', 'theme_boost_union_dhoch3'), $types);
        $mform->setDefault('type', smartmenu::TYPE_LIST);
        $mform->setType('type', PARAM_INT);
        $mform->addHelpButton('type', 'smartmenusmenutype', 'theme_boost_union_dhoch3');

        // Add show description as select element.
        $showdescriptionoptions = [
                smartmenu::DESC_NEVER => get_string('smartmenusmenushowdescriptionnever', 'theme_boost_union_dhoch3'),
                smartmenu::DESC_ABOVE => get_string('smartmenusmenushowdescriptionabove', 'theme_boost_union_dhoch3'),
                smartmenu::DESC_BELOW => get_string('smartmenusmenushowdescriptionbelow', 'theme_boost_union_dhoch3'),
                smartmenu::DESC_HELP => get_string('smartmenusmenushowdescriptionhelp', 'theme_boost_union_dhoch3'),
        ];
        $mform->addElement('select', 'showdesc', get_string('smartmenusmenushowdescription', 'theme_boost_union_dhoch3'),
                $showdescriptionoptions);
        $mform->setDefault('showdesc', smartmenu::DESC_NEVER);
        $mform->setType('showdesc', PARAM_INT);
        $mform->addHelpButton('showdesc', 'smartmenusmenushowdescription', 'theme_boost_union_dhoch3');

        // Add more menu behavior as select element.
        $moremenuoptions = [
                smartmenu::MOREMENU_DONOTCHANGE => get_string('dontchange', 'theme_boost_union_dhoch3'),
                smartmenu::MOREMENU_INTO => get_string('smartmenusmenumoremenubehaviorforceinto', 'theme_boost_union_dhoch3'),
                smartmenu::MOREMENU_OUTSIDE => get_string('smartmenusmenumoremenubehaviorkeepoutside', 'theme_boost_union_dhoch3'),
        ];
        $mform->addElement('select', 'moremenubehavior', get_string('smartmenusmenumoremenubehavior', 'theme_boost_union_dhoch3'),
                $moremenuoptions);
        $mform->setDefault('moremenubehavior', smartmenu::MOREMENU_DONOTCHANGE);
        $mform->setType('moremenubehavior', PARAM_INT);
        $mform->addHelpButton('moremenubehavior', 'smartmenusmenumoremenubehavior', 'theme_boost_union_dhoch3');

        // Add CSS class as input element.
        $mform->addElement('text', 'cssclass', get_string('smartmenusmenucssclass', 'theme_boost_union_dhoch3'));
        $mform->addHelpButton('cssclass', 'smartmenusmenucssclass', 'theme_boost_union_dhoch3');
        $mform->setType('cssclass', PARAM_TEXT);

        // Add card size as select element.
        $cardsizeoptions = [
                smartmenu::CARDSIZE_TINY => get_string('smartmenusmenucardsizetiny', 'theme_boost_union_dhoch3').' (50px)',
                smartmenu::CARDSIZE_SMALL => get_string('smartmenusmenucardsizesmall', 'theme_boost_union_dhoch3').' (100px)',
                smartmenu::CARDSIZE_MEDIUM => get_string('smartmenusmenucardsizemedium', 'theme_boost_union_dhoch3').' (150px)',
                smartmenu::CARDSIZE_LARGE => get_string('smartmenusmenucardsizelarge', 'theme_boost_union_dhoch3').' (200px)',
        ];
        $mform->addElement('select', 'cardsize', get_string('smartmenusmenucardsize', 'theme_boost_union_dhoch3'), $cardsizeoptions);
        ...
        $mform->addHelpButton('cardsize', 'smartmenusmenucardsize', 'theme_boost_union_dhoch3');
        ...
        $mform->addElement('select', 'cardform',
                get_string('smartmenusmenucardform', 'theme_boost_union_dhoch3'), $cardformoptions);
        ...
        $mform->addHelpButton('cardform', 'smartmenusmenucardform', 'theme_boost_union_dhoch3');
        ...
        $mform->addElement('select', 'cardoverflowbehavior',
                get_string('smartmenusmenucardoverflowbehavior', 'theme_boost_union_dhoch3'), $cardoverflowoptions);
        ...
        $mform->addHelpButton('cardoverflowbehavior', 'smartmenusmenucardoverflowbehavior', 'theme_boost_union_dhoch3');
        ...
        $actionbuttons[] = &$mform->createElement('submit', 'saveanddisplay',
                get_string('smartmenussavechangesandconfigure', 'theme_boost_union_dhoch3'), $actionclasses);
