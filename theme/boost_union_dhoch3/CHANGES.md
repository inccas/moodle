...
* 2024-03-25 - Upgrade: Boost Union Dhoch3 settings were moved to an admin settings category of its own to support the new theme chooser on Moodle 4.4, resolves #482.
               Please note: This change is backported to Moodle 4.3 to 4.1 as well.
               Child theme support: If you are running a Boost Union Dhoch3 Child theme, please make sure to adapt your child theme to our latest boilerplate.
...
* 2024-03-18 - Improvement: Switch to the active Boost Union Dhoch3 admin sub-tab after saving a setting and the following page reload, resolves #468.
...
* 2024-02-09 - Improvement: Inherit preset setting and preset files from Boost Core instead of duplicating them into Boost Union Dhoch3, resolves #267.
               Please note: The preset setting in Boost Union Dhoch3 was practically broken up to now. Removing the duplicated setting should not break anything.
* 2024-02-06 - Child theme support: Adapt favicon behat scenario to support Boost Union Dhoch3 Child
...
* 2024-01-10 - Bugfix: Avoid debug messages during initial installation of Boost Union Dhoch3 due to uninitialized settings.
...
* 2023-12-18 - Improvement: Shrink description_format column size in theme_boost_union_dhoch3_flavours table, solves #321.
...
* 2023-09-19 - Bugfix: Fix fatal mustache rendering errors, solves #390.
               This issue was a regression of #385 which adopted Moodle core changes from MDL-78656 into Boost Union Dhoch3.
               During this adoption into Boost Union Dhoch3, it was overseen to raise the minimum required Moodle core version for Boost Union Dhoch3 at the same time.
               If you intend to use this release of Boost Union Dhoch3, please update Moodle core to the latest Moodle core 4.2.2+ or wait some more days for 4.2.3. Thank you for your understanding.
...
* 2023-09-17 - Upgrade: Remove 'FontAwesome version' setting as FontAwesome 6 Free has been integrated into Moodle core. Boost Union Dhoch3 will use FontAwesome 6 by default from 4.2 on, solves #389.
...
* 2023-06-03 - Bugfix: Help fixing PHPUnit runs with Boost Union Dhoch3, solves #305.
...
* 2023-03-22 - Feature: Allow admin to provide several additional block regions, solves #30.
               Please note: This is a comparably large addition. If you encounter any issues with this feature, please report it on <https://github.com/moodle-an-hochschulen/moodle-theme_boost_union_dhoch3/issues>.
* 2023-03-20 - Improvement: Don't force child themes to reimplement various color settings (e.g. 'brandcolor'), solves #260.
* 2023-03-17 - Improvement: Reduce code duplication when child theming by checking theme ancestry in theme_boost_union_dhoch3_before_standard_html_head, solves #245.
...
* 2023-02-04 - Upgrade: Persist the dedicated favicon setting in Boost Union Dhoch3 even though Moodle core has a favicon setting in 4.1 as well, solves #78.
* 2023-02-04 - Upgrade: The back-top-top button must respect the presence of the new sticky footer, solves #186.
* 2023-02-04 - Upgrade: Add .footer-support-link class to Boost Union Dhoch3's footer links to align them with Boost Core in 4.1 again
...
* 2023-01-26 - Feature: Add dedicated logo settings to Boost Union Dhoch3, solves #211.
...
* 2023-01-16 - Improvement: Remove Boost Union Dhoch3's own fallback CSS file for now, relates to #89.
...
* 2022-06-20 - Allow full Behat runs with Boost Union Dhoch3 suite, fixes #14.
