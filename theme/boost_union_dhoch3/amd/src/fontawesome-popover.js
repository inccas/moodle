...
/**
 * Theme Boost Union Dhoch3 - JS code which shows all fontawesome icons in a popover.
 *
 * @module     theme_boost_union_dhoch3/fontawesome-popover
...
define(['jquery', 'theme_boost/popover', 'core/fragment', 'core/notification'], function($, popover, Fragment, Notification) {
     ...
     */
    const getIconList = () => {
        return Fragment.loadFragment('theme_boost_union_dhoch3', 'icons_list', contextID, {});
    };
