...
/**
 * Theme Boost Union Dhoch3 - JS code current admin tab selector
 *
 * @module     theme_boost_union_dhoch3/admintab
...
define(['jquery'], function($) {
    ...
    function initAdminTabs() {
        ...
        whenBootstrapIsAvailable(() => {
            ...
            const sessionKey = 'theme_boost_union_dhoch3_active_admin_tab';

            // Register an event listener on all boost union tabs.
            $('a[href^="#theme_boost_union_dhoch3_"]').parent().on("shown.bs.tab", function() {
