...
/**
 * Theme Boost Union Dhoch3 - Local login page
 *
...
// Set page URL.
$PAGE->set_url('/theme/boost_union_dhoch3/locallogin.php');
...
if ($config->loginlocalloginenable != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_NO) {
    echo $OUTPUT->header();
    $loginurl = new moodle_url('/login/index.php');
    $notification = new \core\output\notification(
            get_string('loginlocalloginlocalnotdisabled', 'theme_boost_union_dhoch3', ['url' => $loginurl]),
...
echo $OUTPUT->render_from_template('theme_boost_union_dhoch3/localloginform', $templatecontext);
