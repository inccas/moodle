@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_looksettings @theme_boost_union_dhoch3_looksettings_scss
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "SCSS" tab on the "Look" page
