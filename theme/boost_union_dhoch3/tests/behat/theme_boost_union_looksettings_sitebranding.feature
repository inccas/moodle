@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_looksettings @theme_boost_union_dhoch3_looksettings_sitebranding
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "Site branding" tab on the "Look" page
  ...
  Scenario: Setting: Logo - Upload a custom logo to the theme
    ...
    And I upload "theme/boost_union_dhoch3/tests/fixtures/moodlelogo.png" file to "Logo" filemanager
    And I press "Save changes"
    And I log out
    And I click on "Log in" "link" in the ".logininfo" "css_element"
    # We can't check the uploaded image file visually, but we can verify that the compact logo is shipped from the theme_boost_union_dhoch3 global logo filearea.
    Then "//div[@id='loginlogo']//img[@id='logoimage'][contains(@src, 'pluginfile.php/1/theme_boost_union_dhoch3/logo')][contains(@src, 'moodlelogo.png')]" "xpath_element" should exist
  ...
  Scenario: Setting: Compact logo - Upload a PNG logo to the theme and check that it is resized
    ...
    And I log out
    And I click on "Log in" "link" in the ".logininfo" "css_element"
    Then "//div[@id='loginlogo']//img[@id='logoimage'][contains(@src, 'pluginfile.php/1/theme_boost_union_dhoch3/logo/0x200/')]" "xpath_element" should exist
  ...
  Scenario: Setting: Compact logo - Upload a SVG logo to the theme and check that it is not resized
    ...
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Site branding" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/moodlelogo.svg" file to "Logo" filemanager
    And I press "Save changes"
    And I log out
    And I click on "Log in" "link" in the ".logininfo" "css_element"
    Then "//div[@id='loginlogo']//img[@id='logoimage'][contains(@src, 'pluginfile.php/1/theme_boost_union_dhoch3/logo/1/')]" "xpath_element" should exist
  ...
  Scenario: Setting: Compact logo - Upload a custom compact logo to the theme
    ...
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Site branding" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/moodlelogo.png" file to "Compact logo" filemanager
    And I press "Save changes"
    And I am on site homepage
    # We can't check the uploaded image file visually, but we can verify that the compact logo is shipped from the theme_boost_union_dhoch3 global logo filearea.
    Then "//nav[contains(@class, 'navbar')]//img[contains(@class, 'logo')][contains(@src, 'pluginfile.php/1/theme_boost_union_dhoch3/logocompact')][contains(@src, 'moodlelogo.png')]" "xpath_element" should exist
  ...
  Scenario: Setting: Compact logo - Upload a PNG compact logo to the theme and check that it is resized
    ...
    And I press "Save changes"
    And I am on site homepage
    Then "//nav[contains(@class, 'navbar')]//img[contains(@class, 'logo')][contains(@src, 'pluginfile.php/1/theme_boost_union_dhoch3/logocompact/300x300/')]" "xpath_element" should exist
  ...
  Scenario: Setting: Compact logo - Upload a SVG compact logo to the theme and check that it is not resized
    ...
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Site branding" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/moodlelogo.svg" file to "Compact logo" filemanager
    And I press "Save changes"
    And I am on site homepage
    Then "//nav[contains(@class, 'navbar')]//img[contains(@class, 'logo')][contains(@src, 'pluginfile.php/1/theme_boost_union_dhoch3/logocompact/1/')]" "xpath_element" should exist
  ...
  Scenario: Setting: Favicon - Upload a custom favicon to the theme
    ...
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Site branding" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/favicon.ico" file to "Favicon" filemanager
    And I press "Save changes"
    ...
    Then "//head//link[contains(@rel, 'shortcut')][contains(@href, 'pluginfile.php/1/theme_boost_union_dhoch3/favicon')][contains(@href, 'favicon.ico')]" "xpath_element" should exist
    And "//head//link[contains(@rel, 'shortcut')][contains(@href, 'theme/image.php/boost_union_dhoch3')][contains(@href, 'favicon')]" "xpath_element" should not exist

  @javascript @_file_upload
  Scenario: Setting: Favicon - Do not upload a custom favicon to the theme (countercheck)
    When I log in as "admin"
    Then "//head//link[contains(@rel, 'shortcut')][contains(@href, 'theme/image.php/boost_union_dhoch3')][contains(@href, 'favicon')]" "xpath_element" should exist
    And "//head//link[contains(@rel, 'shortcut')][contains(@href, 'pluginfile.php/1/theme_boost_union_dhoch3/favicon')][contains(@href, 'favicon.ico')]" "xpath_element" should not exist
  ...
  Scenario Outline: Setting: Background image - Define the background image position.
    Given the following config values are set as admin:
      | config                  | value      | plugin            |
      | backgroundimageposition | <position> | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Site branding" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/login_bg1.jpg" file to "Background image" filemanager
    And I press "Save changes"
    And I am on site homepage
  ...
  Scenario: Setting: Brand color - Set the brand color
    Given the following config values are set as admin:
      | config     | value   | plugin            |
      | brandcolor | #FF0000 | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Bootstrap colors - Set the Bootstrap colors
    Given the following config values are set as admin:
      | config               | value      | plugin            |
      | bootstrapcolor<type> | <colorhex> | theme_boost_union_dhoch3 |
    And the following "activities" exist:
      | activity | name      | intro                                                    | course |
  ...
  Scenario Outline: Setting: Navbar color - Set the navbar color
    Given the following config values are set as admin:
      | config      | value     | plugin            |
      | navbarcolor | <setting> | theme_boost_union_dhoch3 |
    When I log in as "admin"
