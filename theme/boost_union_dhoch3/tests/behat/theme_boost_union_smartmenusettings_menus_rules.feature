@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_smartmenusettings @theme_boost_union_dhoch3_smartmenusettings_menus @theme_boost_union_dhoch3_smartmenusettings_menus_rules
Feature: Configuring the theme_boost_union_dhoch3 plugin on the "Smart menus" page, applying different rules to the individual smart menus
