@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_contentsettings @theme_boost_union_dhoch3_contentsettings_footer
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "Footer" tab on the "Content" page
  ...
  Scenario: Setting: Footnote - Use the footnote setting to show a string in the page footer on the Dashboard, on the course pages and on the login page
    Given the following config values are set as admin:
      | config   | value                                                                                              | plugin            |
      | footnote | <span lang="en" class="multilang">Footnote</span><span lang="de" class="multilang">Fussnote</span> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Footer - Enable and disable the footer button
    Given the following config values are set as admin:
      | config             | value   | plugin            |
      | enablefooterbutton | <value> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Footer - Suppress 'Chat to course participants' link
    ...
    And the following config values are set as admin:
      | config             | value   | plugin            |
      | footersuppresschat | <value> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Footer - Suppress 'Documentation for this page' link
    ...
    And the following config values are set as admin:
      | config             | value   | plugin            |
      | footersuppresshelp | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    And I am on "Course 1" course homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
  ...
  Scenario Outline: Setting: Footer - Suppress 'Services and support' link
    ...
    And the following config values are set as admin:
      | config                 | value   | plugin            |
      | footersuppressservices | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
  ...
  Scenario Outline: Setting: Footer - Suppress 'Contact site support' link
    ...
    And the following config values are set as admin:
      | config                | value   | plugin            |
      | footersuppresscontact | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    When I am on site homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
  ...
  Scenario Outline: Setting: Footer - Suppress Login info
    Given the following config values are set as admin:
      | config                  | value   | plugin            |
      | footersuppresslogininfo | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    When I am on site homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
  ...
  Scenario Outline: Setting: Footer - Suppress 'Reset user tour on this page' link
    ...
    Given the following config values are set as admin:
      | config                 | value   | plugin            |
      | footersuppressusertour | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
  ...
  Scenario Outline: Setting: Footer - Suppress 'Give feedback about this software' link
    ...
    And the following config values are set as admin:
      | config                 | value   | plugin            |
      | footersuppressfeedback | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    When I am on site homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
  ...
  Scenario Outline: Setting: Footer - Suppress 'Powered by Moodle' link
    Given the following config values are set as admin:
      | config                | value   | plugin            |
      | footersuppresspowered | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    When I am on site homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
  ...
  Scenario Outline: Setting: Footer - Suppress footer output by plugin 'Data privacy'
    ...
    And the following config values are set as admin:
      | config                                        | value   | plugin            |
      | footersuppressstandardfooter_tool_dataprivacy | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    When I am on site homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
  ...
  Scenario Outline: Setting: Footer - Suppress footer output by plugin 'Moodle app tools'
    ...
    And the following config values are set as admin:
      | config                                   | value   | plugin            |
      | footersuppressstandardfooter_tool_mobile | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    When I am on site homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
  ...
  Scenario Outline: Setting: Footer - Suppress footer output by plugin 'Policies'
    ...
    And the following config values are set as admin:
      | config                                   | value   | plugin            |
      | footersuppressstandardfooter_tool_policy | <value> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    When I am on site homepage
    And I click on ".btn-footer-popover" "css_element" in the "#page-footer" "css_element"
