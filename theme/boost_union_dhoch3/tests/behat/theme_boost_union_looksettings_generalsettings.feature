@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_looksettings @theme_boost_union_dhoch3_looksettings_generalsettings
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "General settings" tab on the "Look" page
  ...
  Scenario: Setting: Inherit theme preset from Boost Core to Boost Union Dhoch3
    ...
    And I upload "theme/boost_union_dhoch3/tests/fixtures/preset.scss" file to "Additional theme preset files" filemanager
