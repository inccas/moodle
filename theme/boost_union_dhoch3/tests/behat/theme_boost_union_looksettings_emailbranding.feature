@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_looksettings @theme_boost_union_dhoch3_looksettings_emailbranding
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "E-Mail branding" tab on the "Look" page
  In order to use the features
  As admin
  I need to be able to configure the theme Boost Union Dhoch3 plugin

#  Unfortunately, this can't be tested with Behat yet
#  See https://github.com/moodle-an-hochschulen/moodle-theme_boost_union_dhoch3/issues/140 for details
#  @javascript
#  Scenario: Setting: HTML E-Mail branding
#    Given the following "language customisations" exist:
#      | component         | stringid                | value          |
#      | theme_boost_union_dhoch3 | templateemailhtmlprefix | My HTML prefix |
#      | theme_boost_union_dhoch3 | templateemailhtmlsuffix | My HTML suffix |
...
#    Given the following "language customisations" exist:
#      | component         | stringid                | value               |
#      | theme_boost_union_dhoch3 | templateemailtextprefix | My plaintext prefix |
#      | theme_boost_union_dhoch3 | templateemailtextsuffix | My plaintext suffix |
#    When I log in as "admin"
#    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
#    And I click on "E-Mail branding" "link" in the "#adminsettings .nav-tabs" "css_element"
