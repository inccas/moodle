@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_smartmenusettings @theme_boost_union_dhoch3_smartmenusettings_menuitems @theme_boost_union_dhoch3_smartmenusettings_menuitems_dynamiccourses
Feature: Configuring the theme_boost_union_dhoch3 plugin on the "Smart menus" page, using dynamic menus to automatically compose smart menu items
