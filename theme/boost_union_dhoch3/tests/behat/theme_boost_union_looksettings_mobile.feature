@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_looksettings @theme_boost_union_dhoch3_looksettings_mobile
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "Mobile" tab on the "Look" page
  ...
  Scenario: Setting: Additional CSS for Mobile app - Insert CSS code and test that the mobilecssurl URL is set correctly.
    ...
    Then "//div[@id='admin-mobilecssurl']//input[contains(@value, 'theme/boost_union_dhoch3/mobile/styles.php')]" "xpath_element" should exist
  ...
  Scenario: Setting: Additional CSS for Mobile app - Remove CSS code and test that the mobilecssurl URL is cleared correctly.
    ...
    And the following config values are set as admin:
      | config     | value                       | plugin            |
      | mobilescss | a.test { font-size: 16px; } | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Mobile" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I set the field "Additional CSS for Mobile app" to multiline:
    ...
    And I press "Save changes"
    And I navigate to "General > Mobile app > Mobile appearance" in site administration
    Then "//div[@id='admin-mobilecssurl']//input[contains(@value, 'theme/boost_union_dhoch3/mobile/styles.php')]" "xpath_element" should not exist
  ...
  Scenario: Setting: Touch icon files for iOS - Upload touch icon files
    ...
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Mobile" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/apple-icon-180x180.png" file to "Touch icon files for iOS" filemanager
    And I upload "theme/boost_union_dhoch3/tests/fixtures/apple-icon-60x60.png" file to "Touch icon files for iOS" filemanager
    And I press "Save changes"
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Mobile" "link" in the "#adminsettings .nav-tabs" "css_element"
    ...
    And "//head//link[contains(@rel, 'apple-touch-icon')][contains(@sizes, '180x180')][contains(@href, 'pluginfile.php/1/theme_boost_union_dhoch3/touchiconsios')][contains(@href, 'apple-icon-180x180.png')]" "xpath_element" should exist
    And "//head//link[contains(@rel, 'apple-touch-icon')][contains(@sizes, '152x152')][contains(@href, 'pluginfile.php/1/theme_boost_union_dhoch3/touchiconsios')][contains(@href, 'apple-icon-152x152.png')]" "xpath_element" should not exist
    And "//head//link[contains(@rel, 'apple-touch-icon')][contains(@sizes, '60x60')][contains(@href, 'pluginfile.php/1/theme_boost_union_dhoch3/touchiconsios')][contains(@href, 'apple-icon-60x60.png')]" "xpath_element" should exist
