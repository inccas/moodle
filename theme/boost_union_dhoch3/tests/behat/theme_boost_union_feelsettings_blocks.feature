@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_feelsettings @theme_boost_union_dhoch3_feelsettings_blocks
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "Blocks" tab on the "Feel" page
  ...
  Scenario Outline: Setting: Enable additional block regions (on a course page and the frontpage where all regions are offered)
    ...
    And the following config values are set as admin:
      | config                   | value          | plugin            |
      | blockregionsforfrontpage | <settingvalue> | theme_boost_union_dhoch3 |
    ...
    And the following config values are set as admin:
      | config                | value          | plugin            |
      | blockregionsforcourse | <settingvalue> | theme_boost_union_dhoch3 |
    And I reload the page
    Then "#theme-block-region-<region>" "css_element" <should> exist
  ...
  Scenario Outline: Setting: Enable additional block regions (on the Dashboard page where all but the content-* regions are offered)
    ...
    And the following config values are set as admin:
      | config                     | value          | plugin            |
      | blockregionsformydashboard | <settingvalue> | theme_boost_union_dhoch3 |
    And I reload the page
    Then "#theme-block-region-<region>" "css_element" <should> exist
  ...
  Scenario Outline: Setting: Enable additional block regions (on the admin overview page where not all regions are offered)
    ...
    And the following config values are set as admin:
      | config               | value          | plugin            |
      | blockregionsforadmin | <settingvalue> | theme_boost_union_dhoch3 |
    And I reload the page
    Then "#theme-block-region-<region>" "css_element" <should> exist
  ...
  Scenario Outline: Setting: Enable and use the off-canvas block regions (Compared to the other regions, these regions are slightly different and thus they are not covered in the Scenario outlines above).
    When I log in as "admin"
    And I am on site homepage
    Then "#theme_boost_union_dhoch3-offcanvas-btn" "css_element" should not exist
    And "#theme_boost_union_dhoch3-drawers-offcanvas" "css_element" should not exist
    ...
    And "#theme-block-region-<region>" "css_element" should not exist
    And I turn editing mode on
    Then "#theme_boost_union_dhoch3-offcanvas-btn" "css_element" should exist
    And "#theme_boost_union_dhoch3-drawers-offcanvas" "css_element" should not exist
    And "#theme-block-region-offcanvas-editing" "css_element" should not be visible
    And "#theme-block-region-<region>" "css_element" should exist
    And "#theme-block-region-<region>" "css_element" should not be visible
    And I click on "#theme_boost_union_dhoch3-offcanvas-btn" "css_element"
    And "#theme_boost_union_dhoch3-drawers-offcanvas" "css_element" should not exist
    ...
    And I turn editing mode off
    Then "#theme_boost_union_dhoch3-offcanvas-btn" "css_element" should exist
    And "#theme_boost_union_dhoch3-drawers-offcanvas" "css_element" should exist
    And "#theme-block-region-offcanvas-editing" "css_element" should not be visible
    And "#theme-block-region-<region>" "css_element" should exist
    And "#theme-block-region-<region>" "css_element" should not be visible
    And I click on "#theme_boost_union_dhoch3-offcanvas-btn" "css_element"
    Then "#theme_boost_union_dhoch3-drawers-offcanvas" "css_element" should exist
    And "#theme-block-region-offcanvas-editing" "css_element" should not be visible
    And "#theme-block-region-<region>" "css_element" should exist
    And "#theme-block-region-<region>" "css_element" should be visible
  ...
  Scenario Outline: Setting: Set capabilities to control the editability of additional block regions (for all regions except offcanvas regions)
    Given the following config values are set as admin:
      | config                | value    | plugin            |
      | blockregionsforcourse | <region> | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I am on "Course 1" course homepage
    And I turn editing mode on
    And I click on "Add a block" "link" in the "#theme-block-region-<region>" "css_element"
    ...
    And the following "permission overrides" exist:
      ...
      | theme/boost_union_dhoch3:<editcapability> | Prevent    | editingteacher | System       |           |
    And I reload the page
    Then "#theme-block-region-<region>" "css_element" should exist
  ...
  Scenario Outline: Setting: Set capabilities to control the visibility of additional block regions (for all regions except offcanvas regions)
    ...
    And the following "permission overrides" exist:
      | capability                         | permission | role           | contextlevel | reference |
      | theme/boost_union_dhoch3:<viewcapability> | Prevent    | user           | System       |           |
      | theme/boost_union_dhoch3:<viewcapability> | Prevent    | editingteacher | System       |           |
    And I reload the page
    Then "#theme-block-region-<region>" "css_element" should not exist
  ...
  Scenario Outline: Setting: Block region width for 'Outside (left/right)' regions
    Given the following config values are set as admin:
      | config                | value          | plugin            |
      | blockregionsforcourse | <region>       | theme_boost_union_dhoch3 |
      | <config>              | <settingvalue> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Block region width for 'Footer' regions
    Given the following config values are set as admin:
      | config                | value          | plugin            |
      | blockregionsforcourse | footer-left    | theme_boost_union_dhoch3 |
      | <config>              | <settingvalue> | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I am on "Course 1" course homepage
    And I turn editing mode on
  ...
  Scenario Outline: Setting: Outside regions horizontal placement
    Given the following config values are set as admin:
      | config                  | value          | plugin            |
      | outsideregionsplacement | <settingvalue> | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I am on site homepage
    And I turn editing mode on
  ...
  Scenario: Verify orders of all block regions
    Given the following config values are set as admin:
      | config                   | value                                                                                                                                                                           | plugin            |
      | blockregionsforfrontpage | outside-top,outside-left,outside-right,outside-bottom,footer-left,footer-right,footer-center,offcanvas-left,offcanvas-right,offcanvas-center,content-upper,content-lower,header | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I am on site homepage
    And I turn editing mode on
  ...
  Scenario Outline: Setting: Show right-hand block drawer of site home on first login
    Given the following config values are set as admin:
      | config                                       | value     | plugin            |
      | showsitehomerighthandblockdraweronfirstlogin | <setting> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Show right-hand block drawer of site home on visit
    Given the following config values are set as admin:
      | config                                  | value     | plugin            |
      | showsitehomerighthandblockdraweronvisit | <setting> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    And I am on site homepage
    And I turn editing mode on
    And I add the "Text" block
  ...
  Scenario Outline: Setting: Show right-hand block drawer of site home on guest login
    Given the following config values are set as admin:
      | config                                       | value     | plugin            |
      | showsitehomerighthandblockdraweronguestlogin | <setting> | theme_boost_union_dhoch3 |
    And I log in as "admin"
    And I am on site homepage
    And I turn editing mode on
    And I add the "Text" block
