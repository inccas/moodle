@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_flavourssettings @theme_boost_union_dhoch3_flavourssettings_management
Feature: Configuring the theme_boost_union_dhoch3 plugin on the "Flavours" page, managing the individual flavours
