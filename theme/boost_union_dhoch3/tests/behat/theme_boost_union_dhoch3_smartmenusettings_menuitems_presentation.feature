@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_smartmenusettings @theme_boost_union_dhoch3_smartmenusettings_menuitems @theme_boost_union_dhoch3_smartmenusettings_menuitems_presentation
Feature: Configuring the theme_boost_union_dhoch3 plugin on the "Smart menus" page, applying different presentation options to the individual smart menu items
  ...
  Scenario: Smartmenus: Menu items: Presentation - Display the menu item title in different types
    ...
    # Menu bar.
    And I click on "Quick links" "link" in the ".boost-union-dhoch3-menubar" "css_element"
    Then I should see "External links" in the ".boost-union-dhoch3-menubar .menu-item-heading" "css_element"
    And I should see "Resources" in the ".boost-union-dhoch3-menubar .menu-item-static" "css_element"
    And the "href" attribute of ".boost-union-dhoch3-menubar .menu-item-heading" "css_element" should contain "#"
    And the "href" attribute of ".boost-union-dhoch3-menubar .menu-item-static" "css_element" should contain "https://moodle.org"
    # Menu items in user menu.
  ...
  Scenario Outline: Smartmenus: Menu items: Presentation - Display the menu items title with icon
    ...
    And ".fa-info-circle" "css_element" should exist in the ".boost-union-dhoch3-menubar .dropdown-item" "css_element"
  ...
  Scenario: Smartmenus: Menu items: Presentation - Display the card type menu item with background image and colors
    ...
    And I click on "Quick links" "link" in the ".boost-union-dhoch3-menubar" "css_element"
    Then DOM element ".boost-union-dhoch3-menubar .dropdown-menu.show .content-block" should have computed style "background-color" "rgb(3, 31, 195)"
    And I click on ".action-edit" "css_element" in the "Resources" "table_row"
    And I expand all fieldsets
    And I upload "theme/boost_union_dhoch3/tests/fixtures/backimg.jpg" file to "Card image" filemanager
    And I click on "Save changes" "button"
    Then I should see smart menu "Quick links" item "Resources" in location "Main, Menu"
    And the image at "//div[contains(@class, 'primary-navigation')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/theme_boost_union_dhoch3/smartmenus_itemimage/')]" "xpath_element" should be identical to "theme/boost_union_dhoch3/tests/fixtures/backimg.jpg"
