@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_looksettings @theme_boost_union_dhoch3_looksettings_loginpage
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "Login page" tab on the "Look" page
  ...
  Scenario: Setting: Login page background images - Upload one custom login background image
    ...
    And I upload "theme/boost_union_dhoch3/tests/fixtures/login_bg1.jpg" file to "Login page background images" filemanager
  ...
  Scenario: Setting: Login page background images - Upload multiple custom login background image (and have one picked randomly)
    ...
    And I click on "Login page" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/login_bg1.jpg" file to "Login page background images" filemanager
    And I upload "theme/boost_union_dhoch3/tests/fixtures/login_bg2.jpg" file to "Login page background images" filemanager
    And I upload "theme/boost_union_dhoch3/tests/fixtures/login_bg3.jpg" file to "Login page background images" filemanager
    And I press "Save changes"
    And I log out
    And I click on "Log in" "link" in the ".logininfo" "css_element"
    Then the "class" attribute of "body" "css_element" should contain "path-login"
  ...
  Scenario Outline: Setting: Login page background images - Define the background image position.
    Given the following config values are set as admin:
      | config                       | value      | plugin            |
      | loginbackgroundimageposition | <position> | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I navigate to "Appearance > Boost Union Dhoch3 > Look" in site administration
    And I click on "Login page" "link" in the "#adminsettings .nav-tabs" "css_element"
    And I upload "theme/boost_union_dhoch3/tests/fixtures/login_bg1.jpg" file to "Login page background images" filemanager
  ...
  Scenario Outline: Setting: Login form position
    Given the following config values are set as admin:
      | config            | value     | plugin            |
      | loginformposition | <setting> | theme_boost_union_dhoch3 |
    When I am on site homepage
    And I click on "Log in" "link" in the ".logininfo" "css_element"
  ...
  Scenario Outline: Setting: Login form transparency
    Given the following config values are set as admin:
      | config                | value     | plugin            |
      | loginformtransparency | <setting> | theme_boost_union_dhoch3 |
    When I am on site homepage
    And I click on "Log in" "link" in the ".logininfo" "css_element"
  ...
  Scenario Outline: Setting: Local login
    Given the following config values are set as admin:
      | config                | value     | plugin            |
      | loginlocalloginenable | <setting> | theme_boost_union_dhoch3 |
    When I am on site homepage
    And I click on "Log in" "link" in the ".logininfo" "css_element"
  ...
  Scenario: Setting: Local login - Use the side entrance login page
    Given the following config values are set as admin:
      | config                | value | plugin            |
      | loginlocalloginenable | no    | theme_boost_union_dhoch3 |
    When I am on local login page
  ...
  Scenario Outline: Setting: Local login intro
    Given the following config values are set as admin:
      | config              | value     | plugin            |
      | loginlocalshowintro | <setting> | theme_boost_union_dhoch3 |
    When I am on site homepage
    And I click on "Log in" "link" in the ".logininfo" "css_element"
    Then "#theme_boost_union_dhoch3-loginorder-local .login-heading" "css_element" <shouldornot> exist
  ...
  Scenario Outline: Setting: IDP login intro
    Given the following config values are set as admin:
      | config            | value     | plugin            |
      | loginidpshowintro | <setting> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Login order
    Given the following config values are set as admin:
      | config                    | value                         | plugin            |
      | loginorderlocal           | <localordersetting>           | theme_boost_union_dhoch3 |
      | loginorderidp             | <idpordersetting>             | theme_boost_union_dhoch3 |
      | loginorderfirsttimesignup | <firsttimesignupordersetting> | theme_boost_union_dhoch3 |
      | loginorderguest           | <guestordersetting>           | theme_boost_union_dhoch3 |
    ...
    Then DOM element "#theme_boost_union_dhoch3-loginorder" should have computed style "display" "<display>"
    And DOM element "#theme_boost_union_dhoch3-loginorder" should have computed style "flex-direction" "<flexdirection>"
    And DOM element "#theme_boost_union_dhoch3-loginorder-local" should have computed style "order" "<localorderbrowser>"
    And DOM element "#theme_boost_union_dhoch3-loginorder-idp" should have computed style "order" "<idporderbrowser>"
    And DOM element "#theme_boost_union_dhoch3-loginorder-firsttimesignup" should have computed style "order" "<firsttimesignuporderbrowser>"
    And DOM element "#theme_boost_union_dhoch3-loginorder-guest" should have computed style "order" "<guestorderbrowser>"
