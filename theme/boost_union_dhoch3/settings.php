...
if ($hassiteconfig || has_capability('theme/boost_union:configure', context_system::instance())) {
    ...
    $mainsettingspageurl = new \core\url('/admin/settings.php', ['section' => 'themesettingboost_union_dhoch3']);
    if ($ADMIN->fulltree && $PAGE->has_set_url() && $PAGE->url->compare($mainsettingspageurl)) {
        redirect(new \core\url('/admin/settings.php', ['section' => 'theme_boost_union_dhoch3']));
    }

    // Create empty settings page structure to make the site administration work on non-admin pages.
    if (!$ADMIN->fulltree) {
        // Create Boost Union DHoch3 settings page
        // (and allow users with the theme/boost_union:configure capability to access it).
        $tab = new admin_settingpage('theme_boost_union_dhoch3',
                get_string('configtitle', 'theme_boost_union_dhoch3', null, true),
    ...
    // phpcs:disable moodle.ControlStructures.ControlSignature.Found
        ...
        // Create Boost Union DHoch3 settings page with tabs
        // (and allow users with the theme/boost_union:configure capability to access it).
        $page = new theme_boost_admin_settingspage_tabs('theme_boost_union_dhoch3',
                get_string('configtitle', 'theme_boost_union_dhoch3', null, true),
                'theme/boost_union:configure');


        // Create general settings tab.
        $tab = new admin_settingpage('theme_boost_union_dhoch3_general',
                get_string('generalsettings', 'theme_boost', null, true));

        // Create inheritance heading.
        $name = 'theme_boost_union_dhoch3/inheritanceheading';
        $title = get_string('inheritanceheading', 'theme_boost_union_dhoch3', null, true);
        ...
        $name = 'theme_boost_union_dhoch3/prescssinheritance';
        $title = get_string('prescssinheritancesetting', 'theme_boost_union_dhoch3', null, true);
        ...
        $name = 'theme_boost_union_dhoch3/extrascssinheritance';
        $title = get_string('extrascssinheritancesetting', 'theme_boost_union_dhoch3', null, true);
        ...
        /**********************************************************
         * EXTENSION POINT:
         * Add your Boost Union DHoch3 settings here.
         *********************************************************/
