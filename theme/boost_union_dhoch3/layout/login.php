...
/**
 * Theme Boost Union Dhoch3 Login - Login page layout.
 *
...
list($loginbackgroundimagetext, $loginbackgroundimagetextcolor) = theme_boost_union_dhoch3_get_loginbackgroundimage_text();
...
$templatecontext = [
    ...
    'loginwrapperclass' => 'login-wrapper-'.get_config('theme_boost_union_dhoch3', 'loginformposition'),
    'logincontainerclass' =>
            (get_config('theme_boost_union_dhoch3', 'loginformtransparency') == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) ?
                    'login-container-80t' : '',
];
...
// Render login.mustache from theme_boost (which is overridden in theme_boost_union_dhoch3).
