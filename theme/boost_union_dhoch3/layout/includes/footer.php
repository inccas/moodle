...
/**
 * Theme Boost Union Dhoch3 - Footer question mark button layout include.
 *
...
$footersetting = get_config('theme_boost_union_dhoch3', 'enablefooterbutton');

// If the footer button is enabled.
$footerquestionmark = isset($footersetting) ? $footersetting : THEME_BOOST_UNION_DHOCH3_SETTING_ENABLEFOOTER_ALL;
if ($footerquestionmark != THEME_BOOST_UNION_DHOCH3_SETTING_ENABLEFOOTER_NONE) {
    ...
    $footersuppresschatsetting = get_config('theme_boost_union_dhoch3', 'footersuppresschat');
    if (!isset($footersuppresschatsetting) || $footersuppresschatsetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
    ...
    $footersuppresshelpsetting = get_config('theme_boost_union_dhoch3', 'footersuppresshelp');
    if (!isset($footersuppresshelpsetting) || $footersuppresshelpsetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    $footersuppressservicessetting = get_config('theme_boost_union_dhoch3', 'footersuppressservices');
    if (!isset($footersuppressservicessetting) || $footersuppressservicessetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    $footersuppresscontactsetting = get_config('theme_boost_union_dhoch3', 'footersuppresscontact');
    if (!isset($footersuppresscontactsetting) || $footersuppresscontactsetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    $footersuppresslogininfosetting = get_config('theme_boost_union_dhoch3', 'footersuppresslogininfo');
    if (!isset($footersuppresslogininfosetting) || $footersuppresslogininfosetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    $footersuppressusertoursetting = get_config('theme_boost_union_dhoch3', 'footersuppressusertour');
    if (!isset($footersuppressusertoursetting) || $footersuppressusertoursetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    $footersuppresspoweredsetting = get_config('theme_boost_union_dhoch3', 'footersuppresspowered');
    if (!isset($footersuppresspoweredsetting) || $footersuppresspoweredsetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Add marker to show this link.
