...
/**
 * Theme Boost Union Dhoch3 - scrollspy include.
 *
...
$scrollspy = get_config('theme_boost_union_dhoch3', 'scrollspy');
...
if ($PAGE->pagelayout == 'course' && $PAGE->course->id != SITEID &&
        $scrollspy == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
    $PAGE->requires->js_call_amd('theme_boost_union_dhoch3/scrollspy', 'init');
}
