...
/**
 * Theme Boost Union Dhoch3 - course index modification include
 *
...
$showcmicon = get_config('theme_boost_union_dhoch3', 'courseindexmodiconenabled');
if ($showcmicon == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
    // Add a class to the body tag.
    $extraclasses[] = 'hascourseindexcmicons';

    // Switch between the possible activity completion presentation modes.
    $completionposition = get_config('theme_boost_union_dhoch3', 'courseindexcompletioninfoposition');
    switch ($completionposition) {
        // Completion encoded in icon color.
        case THEME_BOOST_UNION_DHOCH3_SETTING_COMPLETIONINFOPOSITION_ICONCOLOR:
            $extraclasses[] = 'hascourseindexcplicon';
            break;
        // Completion at start of line.
        case THEME_BOOST_UNION_DHOCH3_SETTING_COMPLETIONINFOPOSITION_STARTOFLINE:
            $extraclasses[] = 'hascourseindexcplsol';
            break;
        // Completion at end of line.
        case THEME_BOOST_UNION_DHOCH3_SETTING_COMPLETIONINFOPOSITION_ENDOFLINE:
