...
/**
 * Theme Boost Union Dhoch3 - Navbar layout include.
 *
...
$navbarcolorsetting = get_config('theme_boost_union_dhoch3', 'navbarcolor');
switch($navbarcolorsetting) {
    case THEME_BOOST_UNION_DHOCH3_SETTING_NAVBARCOLOR_DARK:
        $templatecontext['navbarcolorclasses'] = 'navbar-dark bg-dark';
        break;
    case THEME_BOOST_UNION_DHOCH3_SETTING_NAVBARCOLOR_PRIMARYLIGHT:
        $templatecontext['navbarcolorclasses'] = 'navbar-light bg-primary';
        break;
    case THEME_BOOST_UNION_DHOCH3_SETTING_NAVBARCOLOR_PRIMARYDARK:
        $templatecontext['navbarcolorclasses'] = 'navbar-dark bg-primary';
        break;
    case THEME_BOOST_UNION_DHOCH3_SETTING_NAVBARCOLOR_LIGHT:
    default:
...
$alternativelogolinkurlsetting = get_config('theme_boost_union_dhoch3', 'alternativelogolinkurl');
...
$showfullnameinusermenusetting = get_config('theme_boost_union_dhoch3', 'showfullnameinusermenu');
if ($showfullnameinusermenusetting == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
