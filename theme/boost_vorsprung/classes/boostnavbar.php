...
namespace theme_boost_vorsprung;
...
/**
 * Creates a navbar for boost_vorsprung that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_boost_vorsprung();
    }

    /**
     * Prepares the navigation nodes for use with boost_vorsprung.
     */
    protected function prepare_nodes_for_boost_vorsprung(): void {
        global $PAGE;
    ...
    /**
     * Removes all navigation items out of this boost_vorsprung navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_vorsprung navbar.
     *
