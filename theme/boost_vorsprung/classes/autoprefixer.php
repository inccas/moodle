 ...
 * theme Boost_Vorsprung when working with Bootstrap 4 alpha. We do not recommend
...
class autoprefixer {
    ...
    public function __construct(Document $tree) {
        debugging('theme_boost_vorsprung\autoprefixer() is deprecated. Required prefixes for Bootstrap ' .
            'are now in theme/boost_vorsprung/scss/moodle/prefixes.scss', DEBUG_DEVELOPER);
        $this->tree = $tree;
