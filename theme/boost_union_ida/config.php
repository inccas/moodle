...
/**
 * Theme Boost Union IDA - Theme config
 *
...
// This move will save us from duplicating all lines from Boost Union's config.php into Boost Union IDA's config.php.
...
// Then, we require Boost Union IDA's locallib.php to make sure that it's always loaded.
require_once($CFG->dirroot . '/theme/boost_union_ida/locallib.php');

// Next, we overwrite only the settings which differ between Boost Union and Boost Union IDA.
...
// Lastly, we replicate some settings from Boost Union at runtime into Boost Union IDA's settings.
...
// it would be quite ugly to duplicate all of these settings again to Boost Union IDA.
