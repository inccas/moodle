...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        $showlocallogin = ($loginlocalloginsetting != false) ? $loginlocalloginsetting : THEME_BOOST_UNION_IDA_SETTING_SELECT_YES;
        if ($showlocallogin == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        ...
        if ($showlocalloginintro == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        ...
        $showidploginintro = ($loginidpshowintrosetting != false) ?
                $loginidpshowintrosetting : THEME_BOOST_UNION_IDA_SETTING_SELECT_YES;
        if ($showidploginintro == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
    ...
    public function standard_footer_html() {
        ...
        foreach ($pluginswithfunction as $plugintype => $plugins) {
            foreach ($plugins as $pluginname => $function) {
                ...
                if (isset($suppresssetting) && $suppresssetting == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
                    // Skip the plugin.
                    continue;
    ...
    public function supportemail(array $customattribs = [], bool $embed = false): string {
        ...
        if (isset($footericonsetting) && $footericonsetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
