...
class flavours_overview_table extends \table_sql {
    ...
    public function __construct() {
        ...
        $headers[] = get_string('flavourstitle', 'theme_boost_union_ida');
        $headers[] = get_string('flavoursdescription', 'theme_boost_union_ida');
        $headers[] = get_string('flavoursappliesto', 'theme_boost_union_ida');
        ...
        $this->count = 0;
        $this->totalflavours = $DB->count_records('theme_boost_union_ida_flavours');
    }
    ...
    public function col_updown($data) {
        ...
        // Prepare action URL.
        $actionurl = new \moodle_url('/theme/boost_union_ida/flavours/overview.php');
    ...
    public function col_actions($data) {
        ...
        return
            $OUTPUT->single_button(
                    new \moodle_url('/theme/boost_union_ida/flavours/preview.php', ['id' => $data->id]),
                    get_string('flavourspreview', 'theme_boost_union_ida'), 'get').
            $OUTPUT->single_button(
                    new \moodle_url('/theme/boost_union_ida/flavours/edit.php', ['action' => 'edit', 'id' => $data->id]),
                    get_string('flavoursedit', 'theme_boost_union_ida'), 'get').
            $OUTPUT->single_button(
                    new \moodle_url('/theme/boost_union_ida/flavours/edit.php', ['action' => 'delete', 'id' => $data->id]),
                    get_string('flavoursdelete', 'theme_boost_union_ida'), 'get');
    }
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        ...
        $sql = 'SELECT *
                FROM {theme_boost_union_ida_flavours} t
                ORDER BY sort';
    ...
    public function print_nothing_to_display() {
        ...
        $notification = new \core\output\notification(
                get_string('flavoursnothingtodisplay', 'theme_boost_union_ida'), \core\output\notification::NOTIFY_INFO);
