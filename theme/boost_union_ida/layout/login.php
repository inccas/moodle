 ...
 * * Render theme_boost_union_ida/login instead of theme_boost/login template
 * * Include footnote
...
list($loginbackgroundimagetext, $loginbackgroundimagetextcolor) = theme_boost_union_ida_get_loginbackgroundimage_text();
...
// Render login.mustache from boost_union_ida.
echo $OUTPUT->render_from_template('theme_boost_union_ida/login', $templatecontext);
