 ...
 * * Render theme_boost_union_ida/drawers instead of theme_boost/drawers template
...
// Render drawers.mustache from boost_union_ida.
echo $OUTPUT->render_from_template('theme_boost_union_ida/drawers', $templatecontext);
