...
if ($footerquestionmark != THEME_BOOST_UNION_SETTING_ENABLEFOOTER_NONE) {
    ...
    if (!isset($footersuppresschatsetting) || $footersuppresschatsetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
    ...
    if (!isset($footersuppresshelpsetting) || $footersuppresshelpsetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    if (!isset($footersuppressservicessetting) || $footersuppressservicessetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    if (!isset($footersuppresscontactsetting) || $footersuppresscontactsetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    if (!isset($footersuppresslogininfosetting) || $footersuppresslogininfosetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    if (!isset($footersuppressusertoursetting) || $footersuppressusertoursetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    if (!isset($footersuppresspoweredsetting) || $footersuppresspoweredsetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
        // Add marker to show this link.
    ...
    if (!isset($footersuppressfooterlinkiconssetting) ||
        $footersuppressfooterlinkiconssetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
...
if (isset($enableaccessibilitysupportsetting) &&
        $enableaccessibilitysupportsetting == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES &&
        isset($enableaccessibilitysupportfooterbuttonsetting) &&
        $enableaccessibilitysupportfooterbuttonsetting == THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) {
    ...
    if (!(isset($allowaccessibilitysupportwithoutloginsetting) &&
            $allowaccessibilitysupportwithoutloginsetting != THEME_BOOST_UNION_IDA_SETTING_SELECT_YES) ||
