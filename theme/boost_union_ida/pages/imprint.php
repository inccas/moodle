...
// Set page URL.
$PAGE->set_url('/theme/boost_union_ida/pages/imprint.php');
...
$PAGE->add_body_class('theme_boost_union_ida-imprint');
...
if ($config->enableimprint != THEME_boost_union_ida_SETTING_SELECT_YES) {
    echo $OUTPUT->header();
    $notification = new \core\output\notification(get_string('imprintdisabled', 'theme_boost_union_ida'),
...
// Set page title.
$PAGE->set_title(theme_boost_union_ida_get_staticpage_pagetitle('imprint'));

// Start page output.
echo $OUTPUT->header();

// Show page heading.
echo $OUTPUT->heading(theme_boost_union_ida_get_staticpage_pagetitle('imprint'));
