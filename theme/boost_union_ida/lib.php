...
define('THEME_boost_union_ida_SETTING_STATICPAGELINKPOSITION_FOOTNOTE', 'footnote');
define('THEME_boost_union_ida_SETTING_STATICPAGELINKPOSITION_FOOTER', 'footer');
define('THEME_boost_union_ida_SETTING_STATICPAGELINKPOSITION_BOTH', 'both');

define('THEME_boost_union_ida_SETTING_HIDENODESPRIMARYNAVIGATION_HOME', 'home');
define('THEME_boost_union_ida_SETTING_HIDENODESPRIMARYNAVIGATION_MYHOME', 'myhome');
define('THEME_boost_union_ida_SETTING_HIDENODESPRIMARYNAVIGATION_MYCOURSES', 'courses');
define('THEME_boost_union_ida_SETTING_HIDENODESPRIMARYNAVIGATION_SITEADMIN', 'siteadminnode');

define('THEME_boost_union_ida_SETTING_INFOBANNER_COUNT', 5);
define('THEME_boost_union_ida_SETTING_INFOBANNERPAGES_MY', 'mydashboard');
define('THEME_boost_union_ida_SETTING_INFOBANNERPAGES_MYCOURSES', 'mycourses');
define('THEME_boost_union_ida_SETTING_INFOBANNERPAGES_SITEHOME', 'frontpage');
define('THEME_boost_union_ida_SETTING_INFOBANNERPAGES_COURSE', 'course');
define('THEME_boost_union_ida_SETTING_INFOBANNERPAGES_LOGIN', 'login');
define('THEME_boost_union_ida_SETTING_INFOBANNERMODE_PERPETUAL', 'perp');
define('THEME_boost_union_ida_SETTING_INFOBANNERMODE_TIMEBASED', 'time');

define('THEME_boost_union_ida_SETTING_ADVERTISEMENTTILES_COUNT', 12);
define('THEME_boost_union_ida_SETTING_ADVERTISEMENTTILES_COLUMN_COUNT', 4);
define('THEME_boost_union_ida_SETTING_ADVERTISEMENTTILES_FRONTPAGEPOSITION_BEFORE', 1);
define('THEME_boost_union_ida_SETTING_ADVERTISEMENTTILES_FRONTPAGEPOSITION_AFTER', 2);

define('THEME_boost_union_ida_SETTING_FAVERSION_NONE', 'none');
define('THEME_boost_union_ida_SETTING_FAVERSION_FA6FREE', 'fa6free');
define('THEME_boost_union_ida_SETTING_FAFILES_MANDATORY', 'm');
define('THEME_boost_union_ida_SETTING_FAFILES_OPTIONAL', 'o');

define('THEME_boost_union_ida_SETTING_HEIGHT_100PX', '100px');
define('THEME_boost_union_ida_SETTING_HEIGHT_150PX', '150px');
define('THEME_boost_union_ida_SETTING_HEIGHT_200PX', '200px');
define('THEME_boost_union_ida_SETTING_HEIGHT_250PX', '250px');

define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_CENTER_CENTER', 'center center');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_CENTER_TOP', 'center top');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_CENTER_BOTTOM', 'center bottom');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_LEFT_TOP', 'left top');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_LEFT_CENTER', 'left center');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_LEFT_BOTTOM', 'left bottom');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_RIGHT_TOP', 'right top');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_RIGHT_CENTER', 'right center');
define('THEME_boost_union_ida_SETTING_IMAGEPOSITION_RIGHT_BOTTOM', 'right bottom');

define('THEME_boost_union_ida_SETTING_COURSEIMAGELAYOUT_STACKEDDARK', 'stackeddark');
define('THEME_boost_union_ida_SETTING_COURSEIMAGELAYOUT_STACKEDLIGHT', 'stackedlight');
define('THEME_boost_union_ida_SETTING_COURSEIMAGELAYOUT_HEADINGABOVE', 'headingabove');

define('THEME_boost_union_ida_SETTING_LINKTARGET_SAMEWINDOW', 'same');
define('THEME_boost_union_ida_SETTING_LINKTARGET_NEWTAB', 'new');

define('THEME_boost_union_ida_SETTING_LOGINFORMPOS_CENTER', 'center');
define('THEME_boost_union_ida_SETTING_LOGINFORMPOS_LEFT', 'left');
define('THEME_boost_union_ida_SETTING_LOGINFORMPOS_RIGHT', 'right');

define('THEME_boost_union_ida_SETTING_NAVBARCOLOR_LIGHT', 'light');
define('THEME_boost_union_ida_SETTING_NAVBARCOLOR_DARK', 'dark');
define('THEME_boost_union_ida_SETTING_NAVBARCOLOR_PRIMARYLIGHT', 'primarylight');
define('THEME_boost_union_ida_SETTING_NAVBARCOLOR_PRIMARYDARK', 'primarydark');

define('THEME_boost_union_ida_SETTING_COURSEBREADCRUMBS_DONTCHANGE', 'dontchange');

define('THEME_boost_union_ida_SETTING_OUTSIDEREGIONSPLACEMENT_NEXTMAINCONTENT', 'nextmaincontent');
define('THEME_boost_union_ida_SETTING_OUTSIDEREGIONSPLACEMENT_NEARWINDOW', 'nearwindowedges');
define('THEME_boost_union_ida_SETTING_OUTSIDEREGIONSWITH_FULLWIDTH', 'fullwidth');
define('THEME_boost_union_ida_SETTING_OUTSIDEREGIONSWITH_COURSECONTENTWIDTH', 'coursecontentwidth');
define('THEME_boost_union_ida_SETTING_OUTSIDEREGIONSWITH_HEROWIDTH', 'herowidth');
 ...
 * @return string
 */
function theme_boost_union_ida_get_main_scss_content($theme) {
    global $CFG;
    ...
    $scss .= file_get_contents($CFG->dirroot . '/theme/boost_union_ida/scss/boost_union_ida/pre.scss');
    if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_boost_union_ida', 'preset', 0, '/', $filename))) {
        $scss .= $presetfile->get_content();
    } else {
        // Safety fallback - maybe new installs etc.
        $scss .= file_get_contents($CFG->dirroot . '/theme/boost_union_ida/scss/preset/default.scss');
    }
    $scss .= file_get_contents($CFG->dirroot . '/theme/boost_union_ida/scss/boost_union_ida/post.scss');
 ...
 * @return array
 */
function theme_boost_union_ida_get_pre_scss($theme) {
    global $CFG;
    ...
    foreach ($configurable as $configkey => $targets) {
        $value = get_config('theme_boost_union_ida', $configkey);
        if (!($value)) {
            continue;
        }
    ...
    if (get_config('theme_boost_union_ida', 'coursecontentmaxwidth')) {
        $scss .= '$course-content-maxwidth: '.get_config('theme_boost_union_ida', 'coursecontentmaxwidth').";\n";
    }
    // Set variables which are influenced by the mediumcontentmaxwidth setting.
    if (get_config('theme_boost_union_ida', 'mediumcontentmaxwidth')) {
        $scss .= '$medium-content-maxwidth: '.get_config('theme_boost_union_ida', 'mediumcontentmaxwidth').";\n";
    }
    // Set variables which are influenced by the h5pcontentmaxwidth setting.
    if (get_config('theme_boost_union_ida', 'h5pcontentmaxwidth')) {
        $scss .= '$h5p-content-maxwidth: '.get_config('theme_boost_union_ida', 'h5pcontentmaxwidth').";\n";
    }
    ...
    if (get_config('theme_boost_union_ida', 'activityiconcoloradministration')) {
        $activityiconcolors[] = '"administration": '.get_config('theme_boost_union_ida', 'activityiconcoloradministration');
    }
    if (get_config('theme_boost_union_ida', 'activityiconcolorassessment')) {
        $activityiconcolors[] = '"assessment": '.get_config('theme_boost_union_ida', 'activityiconcolorassessment');
    }
    if (get_config('theme_boost_union_ida', 'activityiconcolorcollaboration')) {
        $activityiconcolors[] = '"collaboration": '.get_config('theme_boost_union_ida', 'activityiconcolorcollaboration');
    }
    if (get_config('theme_boost_union_ida', 'activityiconcolorcommunication')) {
        $activityiconcolors[] = '"communication": '.get_config('theme_boost_union_ida', 'activityiconcolorcommunication');
    }
    if (get_config('theme_boost_union_ida', 'activityiconcolorcontent')) {
        $activityiconcolors[] = '"content": '.get_config('theme_boost_union_ida', 'activityiconcolorcontent');
    }
    if (get_config('theme_boost_union_ida', 'activityiconcolorinterface')) {
        $activityiconcolors[] = '"interface": '.get_config('theme_boost_union_ida', 'activityiconcolorinterface');
    }
    ...
    if (get_config('theme_boost_union_ida', 'blockregionoutsideleftwidth')) {
        $scss .= '$blockregionoutsideleftwidth: '.get_config('theme_boost_union_ida', 'blockregionoutsideleftwidth').";\n";
    }
    if (get_config('theme_boost_union_ida', 'blockregionoutsiderightwidth')) {
        $scss .= '$blockregionoutsiderightwidth: '.get_config('theme_boost_union_ida', 'blockregionoutsiderightwidth').
                ";\n";
    }

    // Prepend pre-scss.
    if (get_config('theme_boost_union_ida', 'scsspre')) {
        $scss .= get_config('theme_boost_union_ida', 'scsspre');
    }
 ...
 * @return string
 */
function theme_boost_union_ida_get_extra_scss($theme) {
    global $CFG;
    ...
    // Additionally, the custom SCSS from $theme->settings->scss (which hits the SCSS settings from theme_boost_union_ida even though
    ...
    $loginbackgroundimagepresent = get_config('theme_boost_union_ida', 'loginbackgroundimage');
    if (!empty($loginbackgroundimagepresent)) {
        ...
        $content .= theme_boost_union_ida_get_loginbackgroundimage_scss();
    }
    ...
    $content .= theme_boost_union_ida_get_scss_to_mark_external_links($theme);
 ...
 */
function theme_boost_union_ida_get_precompiled_css() {
    global $CFG;
 ...
 * @return bool
 */
function theme_boost_union_ida_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    global $CFG;
    ...
    if (in_array($filearea, ['logo', 'logocompact', 'favicon'])) {
        ...
        $candidate = $CFG->localcachedir . "/theme_boost_union_ida/$themerev/$filearea/{$maxwidth}x{$maxheight}/$filename";
        ...
        $fs = get_file_storage();
        $filepath = "/{$context->id}/theme_boost_union_ida/{$filearea}/0/{$filename}";
        ...
        $theme = theme_config::load('boost_union_ida');
        ...
        if ((!$file = $fs->get_file($context->id, 'theme_boost_union_ida', $filearea, $itemid, '/', $filename)) ||
                $file->is_directory()) {
            send_file_not_found();
        }
 ...
 * @return string
 */
function theme_boost_union_ida_before_standard_html_head() {
    /*
    global $CFG, $PAGE;
