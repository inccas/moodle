@theme @theme_boost_union_ida @theme_boost_union_ida_contentsettings @theme_boost_union_ida_contentsettings_infobanners
Feature: Configuring the theme_boost_union_ida plugin for the "Information banners" tab on the "Content" page
  ...
  Scenario: Setting: Information banners - Display info banner 1 on all available pages
    Given the following config values are set as admin:
      | config             | value                                        | plugin            |
      | infobanner1enabled | yes                                          | theme_boost_union_ida |
      | infobanner1content | "This is a test content"                     | theme_boost_union_ida |
      | infobanner1pages   | mydashboard,mycourses,frontpage,course,login | theme_boost_union_ida |
      | infobanner1mode    | perp                                         | theme_boost_union_ida |
  ...
  Scenario: Setting: Information banners - Display info banner 1 only on one available page
    Given the following config values are set as admin:
      ...
      | infobanner1enabled | yes                      | theme_boost_union_ida |
      | infobanner1content | "This is a test content" | theme_boost_union_ida |
      | infobanner1pages   | mydashboard              | theme_boost_union_ida |
      | infobanner1mode    | perp                     | theme_boost_union_ida |
    When I log in as "teacher1"
    And I am on site homepage
  ...
  Scenario: Setting: Information banners - Display info banner 1 with the different bootstrap color classes
    Given the following config values are set as admin:
      ...
      | infobanner1pages   | mydashboard              | theme_boost_union_ida |
      | infobanner1mode    | perp                     | theme_boost_union_ida |
      | infobanner1bsclass | primary                  | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value     | plugin            |
      | infobanner1bsclass | secondary | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value   | plugin            |
      | infobanner1bsclass | success | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value  | plugin            |
      | infobanner1bsclass | danger | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value   | plugin            |
      | infobanner1bsclass | warning | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value | plugin            |
      | infobanner1bsclass | info  | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value | plugin            |
      | infobanner1bsclass | light | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value | plugin            |
      | infobanner1bsclass | dark  | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
    ...
    Given the following config values are set as admin:
      | config             | value | plugin            |
      | infobanner1bsclass | none  | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
  ...
  Scenario: Setting: Information banners - Do not enable the info banner 1 at all.
    Given the following config values are set as admin:
      | config             | value                              | plugin            |
      | infobanner1enabled | no                                 | theme_boost_union_ida |
      | infobanner1content | "This is a test content"           | theme_boost_union_ida |
      | infobanner1pages   | mydashboard,frontpage,course,login | theme_boost_union_ida |
      | infobanner1mode    | perp                               | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should not see "This is a test content"
  ...
  Scenario: Setting: Information banners - Make the info banner 1 dismissible
    Given the following config values are set as admin:
      ...
      | infobanner1pages       | mydashboard              | theme_boost_union_ida |
      | infobanner1mode        | perp                     | theme_boost_union_ida |
      | infobanner1dismissible | yes                      | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
  ...
  Scenario: Setting: Information banners - Do not make the info banner 1 dismissible (countercheck)
    Given the following config values are set as admin:
      ...
      | infobanner1pages       | mydashboard              | theme_boost_union_ida |
      | infobanner1mode        | perp                     | theme_boost_union_ida |
      | infobanner1dismissible | no                       | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    And I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
  ...
  Scenario: Setting: Information banners - Display multiple, but not all info banners
    Given the following config values are set as admin:
      | config             | value                        | plugin            |
      | infobanner1enabled | yes                          | theme_boost_union_ida |
      | infobanner1content | "This is the first content"  | theme_boost_union_ida |
      | infobanner1pages   | mydashboard                  | theme_boost_union_ida |
      | infobanner1mode    | perp                         | theme_boost_union_ida |
      | infobanner2enabled | no                           | theme_boost_union_ida |
      | infobanner3enabled | yes                          | theme_boost_union_ida |
      | infobanner3content | "This is the second content" | theme_boost_union_ida |
      | infobanner3pages   | mydashboard                  | theme_boost_union_ida |
      | infobanner3mode    | perp                         | theme_boost_union_ida |
      | infobanner4enabled | no                           | theme_boost_union_ida |
      | infobanner5enabled | no                           | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
  ...
  Scenario: Setting: Information banners - Display multiple banners in changed order
    Given the following config values are set as admin:
      | config             | value                        | plugin            |
      | infobanner1enabled | yes                          | theme_boost_union_ida |
      | infobanner1content | "This is the third content"  | theme_boost_union_ida |
      | infobanner1pages   | mydashboard                  | theme_boost_union_ida |
      | infobanner1order   | 2                            | theme_boost_union_ida |
      | infobanner1mode    | perp                         | theme_boost_union_ida |
      | infobanner2enabled | yes                          | theme_boost_union_ida |
      | infobanner2content | "This is the first content"  | theme_boost_union_ida |
      | infobanner2pages   | mydashboard                  | theme_boost_union_ida |
      | infobanner2order   | 1                            | theme_boost_union_ida |
      | infobanner2mode    | perp                         | theme_boost_union_ida |
      | infobanner3enabled | yes                          | theme_boost_union_ida |
      | infobanner3content | "This is the second content" | theme_boost_union_ida |
      | infobanner3pages   | mydashboard                  | theme_boost_union_ida |
      | infobanner3order   | 1                            | theme_boost_union_ida |
      | infobanner3mode    | perp                         | theme_boost_union_ida |
      | infobanner4enabled | yes                          | theme_boost_union_ida |
      | infobanner4content | "This is the fourth content" | theme_boost_union_ida |
      | infobanner4pages   | mydashboard                  | theme_boost_union_ida |
      | infobanner4order   | 2                            | theme_boost_union_ida |
      | infobanner4mode    | perp                         | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
  ...
  Scenario: Setting: Information banners - Display info banner 1 on a time based setting, don't show it yet as the display time is not reached yet.
    Given the following config values are set as admin:
      ...
      | infobanner1content | "This is a test content"    | theme_boost_union_ida |
      | infobanner1pages   | mydashboard                 | theme_boost_union_ida |
      | infobanner1mode    | time                        | theme_boost_union_ida |
      | infobanner1start   | ##first day of next month## | theme_boost_union_ida |
      | infobanner1end     | ##last day of next month##  | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should not see "This is a test content"
  ...
  Scenario: Setting: Information banners - Display info banner 1 on a time based setting, show it as we are within the display time.
    Given the following config values are set as admin:
      ...
      | infobanner1pages   | mydashboard                 | theme_boost_union_ida |
      | infobanner1mode    | time                        | theme_boost_union_ida |
      | infobanner1start   | ##last day of last month##  | theme_boost_union_ida |
      | infobanner1end     | ##first day of next month## | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should see "This is a test content" in the "#themeboostunioninfobanner1" "css_element"
  ...
  Scenario: Setting: Information banners - Display info banner 1 on a time based setting, don't show it anymore as the display time is already over.
    Given the following config values are set as admin:
      ...
      | infobanner1pages   | mydashboard                 | theme_boost_union_ida |
      | infobanner1mode    | time                        | theme_boost_union_ida |
      | infobanner1start   | ##first day of last month## | theme_boost_union_ida |
      | infobanner1end     | ##last day of last month##  | theme_boost_union_ida |
    When I log in as "teacher1"
    And I follow "Dashboard"
    Then I should not see "This is a test content"
