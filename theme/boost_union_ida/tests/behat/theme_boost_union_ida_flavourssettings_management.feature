@theme @theme_boost_union_ida @theme_boost_union_ida_flavourssettings @theme_boost_union_ida_flavourssettings_management
Feature: Configuring the theme_boost_union_ida plugin on the "Flavours" page, managing the individual flavours
