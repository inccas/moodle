@theme @theme_boost_union_ida @theme_boost_union_ida_flavourssettings @theme_boost_union_ida_flavourssettings_caching
Feature: Configuring the theme_boost_union_ida plugin on the "Flavours" page, caching the flavours which apply
