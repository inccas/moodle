...
$definitions = array(
        ...
        // -- theme_boost_union_ida_get_flavour_which_applies() which purges the cache for the affected user).
        'flavours' => array(
                'mode' => cache_store::MODE_SESSION,
                'simplekeys' => true,
                'simpledata' => false,
                'invalidationevents' => array(
                    'theme_boost_union_ida_flavours_resorted',
                    'theme_boost_union_ida_flavours_created',
                    'theme_boost_union_ida_flavours_edited',
                    'theme_boost_union_ida_flavours_deleted',
                    'theme_boost_union_ida_cohort_deleted'
                )
        ),
