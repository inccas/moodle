...
if ($config->enableaccessibilitysupport != THEME_BOOST_UNION_PHD_SETTING_SELECT_YES) {
    echo $OUTPUT->header();
...
if (isset($config->allowaccessibilitysupportwithoutlogin) &&
        $config->allowaccessibilitysupportwithoutlogin != THEME_BOOST_UNION_PHD_SETTING_SELECT_YES) {
