...
$definitions = array(
        ...
        // -- theme_boost_union_phd_get_flavour_which_applies() which purges the cache for the affected user).
        'flavours' => array(
                'mode' => cache_store::MODE_SESSION,
                'simplekeys' => true,
                'simpledata' => false,
                'invalidationevents' => array(
                    'theme_boost_union_phd_flavours_resorted',
                    'theme_boost_union_phd_flavours_created',
                    'theme_boost_union_phd_flavours_edited',
                    'theme_boost_union_phd_flavours_deleted',
                    'theme_boost_union_phd_cohort_deleted'
                )
        ),
