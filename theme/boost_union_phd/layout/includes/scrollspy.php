...
$scrollspy = get_config('theme_boost_union_phd', 'scrollspy');

// Add scroll-spy AMD module if the feature is enabled.
if ($scrollspy == THEME_boost_union_phd_SETTING_SELECT_YES) {
    $PAGE->requires->js_call_amd('theme_boost_union_phd/scrollspy', 'init');
}
