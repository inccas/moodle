 ...
 * * Render theme_boost_union_phd/login instead of theme_boost/login template
 * * Include footnote
...
list($loginbackgroundimagetext, $loginbackgroundimagetextcolor) = theme_boost_union_phd_get_loginbackgroundimage_text();
...
$templatecontext = [
    ...
    'loginwrapperclass' => 'login-wrapper-'.get_config('theme_boost_union_phd', 'loginformposition'),
    'logincontainerclass' =>
            (get_config('theme_boost_union_phd', 'loginformtransparency') == THEME_boost_union_phd_SETTING_SELECT_YES) ?
                    'login-container-80t' : ''
];
...
// Render login.mustache from boost_union_phd.
echo $OUTPUT->render_from_template('theme_boost_union_phd/login', $templatecontext);
