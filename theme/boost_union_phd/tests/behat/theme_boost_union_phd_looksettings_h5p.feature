@theme @theme_boost_union_phd @theme_boost_union_phd_looksettings @theme_boost_union_phd_looksettings_h5p
Feature: Configuring the theme_boost_union_phd plugin for the "H5P" tab on the "Look" page
