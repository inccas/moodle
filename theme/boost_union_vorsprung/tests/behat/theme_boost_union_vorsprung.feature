@theme @theme_boost_union_vorsprung
Feature: Extending the theme_boost_union plugin with a vorsprung theme
  In order to build a vorsprung theme for Boost Union
  As developer
