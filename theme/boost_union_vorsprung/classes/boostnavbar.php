...
/**
 * Creates a navbar for boost_union_vorsprung that allows easy control of the navbar items.
 *
...
class boostnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_boost_union_vorsprung();
    }

    /**
     * Prepares the navigation nodes for use with boost_union_vorsprung.
     */
    protected function prepare_nodes_for_boost_union_vorsprung(): void {
        global $PAGE;
     ...
     *
     * @return boostnavbaritem[] Boost_Vorsprung navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this boost_union_vorsprung navbar
     */
    ...
    /**
     * Remove a boostnavbaritem from the boost_union_vorsprung navbar.
     *
