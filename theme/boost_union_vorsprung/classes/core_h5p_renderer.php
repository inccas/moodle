...
use theme_boost_union_vorsprung\helper\h5p_helper;
...
if (file_exists($CFG->dirroot.'/h5p/classes/output/renderer.php')) {
    if (method_exists(\core_h5p\output\renderer::class, 'h5p_alter_styles')) {
        /**
         * Class theme_boost_union_vorsprung_core_h5p_renderer.
         *
...
if (file_exists($h5prenderer)) {
    ...
    /**
     * Class theme_boost_union_vorsprung_mod_hvp_renderer
     *
     * @package     theme_vorsprung
     * @copyright   2023 Jörg Hagemann
     */
    class theme_boost_union_vorsprung_mod_hvp_renderer extends mod_hvp_renderer {
        use h5p_helper;
