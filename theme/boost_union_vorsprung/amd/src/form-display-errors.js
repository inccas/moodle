 ...
 *
 * @module     theme_boost_union_vorsprung/form-display-errors
...
define(['jquery', 'core_form/events'], function($, FormEvent) {
    return {
        ...
        enhance: function(elementid) {
            ...
            if (form && !('boost_vorsprungFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_vorsprungFormErrorsEnhanced = 1;
            }
        }
    };
});
