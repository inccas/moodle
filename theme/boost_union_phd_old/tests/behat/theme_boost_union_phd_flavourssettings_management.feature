@theme @theme_boost_union_phd @theme_boost_union_phd_flavourssettings @theme_boost_union_phd_flavourssettings_management
Feature: Configuring the theme_boost_union_phd plugin on the "Flavours" page, managing the individual flavours
