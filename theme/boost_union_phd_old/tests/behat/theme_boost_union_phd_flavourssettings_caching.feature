@theme @theme_boost_union_phd @theme_boost_union_phd_flavourssettings @theme_boost_union_phd_flavourssettings_caching
Feature: Configuring the theme_boost_union_phd plugin on the "Flavours" page, caching the flavours which apply
