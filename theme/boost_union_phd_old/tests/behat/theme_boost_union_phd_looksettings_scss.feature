@theme @theme_boost_union_phd @theme_boost_union_phd_looksettings @theme_boost_union_phd_looksettings_scss
Feature: Configuring the theme_boost_union_phd plugin for the "SCSS" tab on the "Look" page
