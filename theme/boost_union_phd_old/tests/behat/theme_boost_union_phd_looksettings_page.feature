@theme @theme_boost_union_phd @theme_boost_union_phd_looksettings @theme_boost_union_phd_looksettings_page
Feature: Configuring the theme_boost_union_phd plugin for the "Page" tab on the "Look" page
