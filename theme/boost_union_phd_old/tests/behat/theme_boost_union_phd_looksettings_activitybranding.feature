@theme @theme_boost_union_phd @theme_boost_union_phd_looksettings @theme_boost_union_phd_looksettings_activitybranding
Feature: Configuring the theme_boost_union_phd plugin for the "Activity branding" tab on the "Look" page
  ...
  Scenario Outline: Setting: Custom icons files - Upload custom icons files
    Given the following config values are set as admin:
      | config         | value | plugin            |
      | modiconsenable | yes   | theme_boost_union_phd |
    ...
    And I upload "theme/boost_union_phd/tests/fixtures/<iconfile>" file to "Custom icons files" filemanager
