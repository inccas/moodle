...
/**
 * Theme Boost Union Dhoch3 - Menu overview page
 *
...
// Access checks.
admin_externalpage_setup('theme_boost_union_dhoch3_smartmenus');
...
$PAGE->set_url(new moodle_url('/theme/boost_union_dhoch3/smartmenus/menus.php'));
...
if ($action !== null && confirm_sesskey()) {
    ...
    $menu = theme_boost_union_dhoch3\smartmenu::instance($menuid);
    ...
    switch ($action) {
        case 'delete':
            ...
            if ($menu->delete_menu()) {
                ...
                \core\notification::success(get_string('smartmenusmenudeletesuccess', 'theme_boost_union_dhoch3'));
            }
            break;
        case 'down':
...
$table = new theme_boost_union_dhoch3\table\smartmenus_menus($context->id);
...
echo get_string('smartmenus_desc', 'theme_boost_union_dhoch3');

// Add experimental warning.
$experimentalnotification = new \core\output\notification(get_string('smartmenusexperimental', 'theme_boost_union_dhoch3'),
...
$createbutton .= $OUTPUT->single_button(
        new \moodle_url('/theme/boost_union_dhoch3/smartmenus/edit.php', ['sesskey' => sesskey()]),
        get_string('smartmenusmenucreate', 'theme_boost_union_dhoch3'), 'get');
$createbutton .= $OUTPUT->box_end();

// If there aren't any smart menus yet.
$countmenus = $DB->count_records('theme_boost_union_dhoch3_menus');
if ($countmenus < 1) {
