...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = []) {
        ...
        if ($this->page->pagelayout == 'login') {
            ...
            if (isset($enableaccessibilitysupportsetting) &&
                    $enableaccessibilitysupportsetting == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES &&
                    isset($enableaccessibilitysupportfooterbuttonsetting) &&
                    $enableaccessibilitysupportfooterbuttonsetting == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
                ...
                if (!(isset($allowaccessibilitysupportwithoutloginsetting) &&
                        $allowaccessibilitysupportwithoutloginsetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) ||
    ...
    public function supportemail(array $customattribs = [], bool $embed = false): string {
        ...
        if (isset($footericonsetting) && $footericonsetting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
