@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_feelsettings @theme_boost_union_dhoch3_feelsettings_navigation
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "Navigation" tab on the "Feel" page
  ...
  Scenario Outline: Setting: Hide a single node in primary navigation.
    Given the following config values are set as admin:
      | config                     | value      | plugin            |
      | hidenodesprimarynavigation | <nodename> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Hide multiple nodes in primary navigation.
    Given the following config values are set as admin:
      | config                     | value       | plugin            |
      | hidenodesprimarynavigation | <nodenames> | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I am on homepage
  ...
  Scenario Outline: Setting: Alternative logo link URL.
    Given the following config values are set as admin:
      | config                 | value     | plugin            |
      | alternativelogolinkurl | <setting> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting:  Show full name in the user menu.
    Given the following config values are set as admin:
      | config                 | value     | plugin            |
      | showfullnameinusermenu | <setting> | theme_boost_union_dhoch3 |
  ...
  Scenario Outline: Setting: Add preferred language link to language menu.
    ...
    And the following config values are set as admin:
      | config           | value     | plugin            |
      | addpreferredlang | <setting> | theme_boost_union_dhoch3 |
    When I log in as "admin"
    And I click on "User menu" "button" in the ".usermenu" "css_element"
  ...
  Scenario Outline: Setting: Show starred courses popover in the navbar.
    Given the following config values are set as admin:
      | config                   | value     | plugin            |
      | shownavbarstarredcourses | <setting> | theme_boost_union_dhoch3 |
  ...
  Scenario: Setting: Show starred courses popover in the navbar (and make sure that I see the right courses there).
    Given the following config values are set as admin:
      | config                   | value | plugin            |
      | shownavbarstarredcourses | yes   | theme_boost_union_dhoch3 |
    And the following "courses" exist:
      | fullname | shortname |
      | Course 2 | C2        |
      | Course 3 | C3        |
  ...
  Scenario Outline: Setting: Course category breadcrumbs
    ...
    And the following config values are set as admin:
      | config              | value     | plugin            |
      | categorybreadcrumbs | <setting> | theme_boost_union_dhoch3 |
  ...
  Scenario: Setting: Course category breadcrumbs (verify that course sections are properly displayed _after_ the categories)
    ...
    And the following config values are set as admin:
      | config              | value     | plugin            |
      | categorybreadcrumbs | yes       | theme_boost_union_dhoch3 |
  ...
  Scenario: Setting: back to top button - Enable "Back to top button"
    Given the following config values are set as admin:
      | config          | value | plugin            |
      | backtotopbutton | yes   | theme_boost_union_dhoch3 |
    And the theme cache is purged and the theme is reloaded
    When I log in as "admin"
  ...
  Scenario: Setting: back to top button - Disable "Back to top button" (countercheck)
    Given the following config values are set as admin:
      | config          | value | plugin            |
      | backtotopbutton | no    | theme_boost_union_dhoch3 |
    And the theme cache is purged and the theme is reloaded
    When I log in as "admin"
    And I am on "Course 1" course homepage
  ...
  Scenario: Setting: Scrollspy - Enable "Scrollspy"
    Given the following config values are set as admin:
      | config          | value | plugin             |
      | scrollspy       | yes   | theme_boost_union_dhoch3  |
    And the theme cache is purged and the theme is reloaded
    When I log in as "admin"
    And I am on "Course 1" course homepage
  ...
  Scenario: Setting: Scrollspy - Disable "Scrollspy" (countercheck)
    Given the following config values are set as admin:
      | config          | value | plugin             |
      | scrollspy       | no    | theme_boost_union_dhoch3  |
    And the theme cache is purged and the theme is reloaded
    When I log in as "admin"
    And I am on "Course 1" course homepage
    And I scroll page to x "0" y "250"
  ...
  Scenario: Setting: Activity navigation - Enable "Activity navigation"
    Given the following config values are set as admin:
      | config             | value | plugin            |
      | activitynavigation | yes   | theme_boost_union_dhoch3 |
  ...
  Scenario: Setting: Activity navigation - Disable "Activity navigation" (countercheck)
    Given the following config values are set as admin:
      | config             | value | plugin            |
      | activitynavigation | no    | theme_boost_union_dhoch3 |
    And the following "activities" exist:
      | activity | name    | course | idnumber |
      | forum    | Forum 1 | C1     | forum1   |
      | forum    | Forum 2 | C1     | forum2   |
