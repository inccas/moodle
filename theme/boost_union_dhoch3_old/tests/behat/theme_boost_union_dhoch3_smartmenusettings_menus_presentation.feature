@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_smartmenusettings @theme_boost_union_dhoch3_smartmenusettings_menus @theme_boost_union_dhoch3_smartmenusettings_menus_presentation
Feature: Configuring the theme_boost_union_dhoch3 plugin on the "Smart menus" page, applying different presentation options to the individual smart menus
  ...
  Scenario: Smartmenu: Menus: Presentation - Display the menus inside and outside more menu
    ...
    And I click on "More" "link" in the ".boost-union-dhoch3-menubar" "css_element"
    ...
    And I click on "More" "link" in the ".boost-union-dhoch3-menubar" "css_element"
    Then I should not see "Test quick demo links 06" in the ".boost-union-dhoch3-menubar .dropdownmoremenu" "css_element"
