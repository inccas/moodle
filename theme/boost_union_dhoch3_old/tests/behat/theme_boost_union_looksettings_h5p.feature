@theme @theme_boost_union_dhoch3 @theme_boost_union_dhoch3_looksettings @theme_boost_union_dhoch3_looksettings_h5p
Feature: Configuring the theme_boost_union_dhoch3 plugin for the "H5P" tab on the "Look" page
  ...
  Scenario: Setting: H5P content bank max width - Overwrite the H5P content bank max width setting
    Given the following config values are set as admin:
      | config             | value | plugin            |
      | h5pcontentmaxwidth | 600px | theme_boost_union_dhoch3 |
