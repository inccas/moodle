...
/**
 * Theme Boost Union Dhoch3 - Local library
 *
 ...
 * @return string.
 */
function theme_boost_union_dhoch3_get_course_related_hints() {
    ...
    if (get_config('theme_boost_union_dhoch3', 'showhintcoursehidden') == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES
            && has_capability('theme/boost_union_dhoch3:viewhintinhiddencourse', \context_course::instance($COURSE->id))
            && $PAGE->has_set_url()
        ...
        if ($PAGE->url->compare(new moodle_url('/course/view.php'), URL_MATCH_BASE)) {
            ...
            $hintcoursehiddentext = get_string('showhintcoursehiddengeneral', 'theme_boost_union_dhoch3');
        }
        ...
        if (get_config('theme_boost_union_dhoch3', 'showhintforumnotifications') == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES
            ...
            $hintcoursehiddentext = get_string('showhintforumnotifications', 'theme_boost_union_dhoch3');
        }
        ...
        if ($hintcoursehiddentext) {
            ...
            $html .= $OUTPUT->render_from_template('theme_boost_union_dhoch3/course-hint-hidden', $templatecontext);
        }
    }
    ...
    // intended.
    if (get_config('theme_boost_union_dhoch3', 'showhintcourseguestaccess') == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES
        ...
        // Render template and add it to HTML code.
        $html .= $OUTPUT->render_from_template('theme_boost_union_dhoch3/course-hint-guestaccess', $templatecontext);
    }
    ...
    // capability "theme/boost_union_dhoch3:viewhintcourseselfenrol".
    if (get_config('theme_boost_union_dhoch3', 'showhintcourseselfenrol') == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES
            && has_capability('theme/boost_union_dhoch3:viewhintcourseselfenrol', \context_course::instance($COURSE->id))
            && $PAGE->has_set_url()
            && $PAGE->url->compare(new moodle_url('/course/view.php'), URL_MATCH_BASE)
            && $COURSE->visible == true) {
        ...
        if (!empty($selfenrolinstances) &&
            ...
            if ($selfenrolmentpossiblecurrently == true) {
                $templatecontext['selfenrolhintstart'] = get_string('showhintcourseselfenrolstartcurrently', 'theme_boost_union_dhoch3');
            } else if ($selfenrolmentpossiblefuture == true) {
                $templatecontext['selfenrolhintstart'] = get_string('showhintcourseselfenrolstartfuture', 'theme_boost_union_dhoch3');
            }
            ...
            foreach ($selfenrolinstances as $selfenrolinstanceid => $selfenrolinstanceobject) {
                ...
                if ($selfenrolinstanceobject->unrestrictedness == 'unlimited') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolunlimited', 'theme_boost_union_dhoch3',
                            ['name' => $selfenrolinstanceobject->name]);
                } else if ($selfenrolinstanceobject->unrestrictedness == 'until') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenroluntil', 'theme_boost_union_dhoch3',
                            ['name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate), ]);
                } else if ($selfenrolinstanceobject->unrestrictedness == 'from') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolfrom', 'theme_boost_union_dhoch3',
                            ['name' => $selfenrolinstanceobject->name,
                                    'from' => userdate($selfenrolinstanceobject->startdate), ]);
                } else if ($selfenrolinstanceobject->unrestrictedness == 'since') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolsince', 'theme_boost_union_dhoch3',
                            ['name' => $selfenrolinstanceobject->name,
                                    'since' => userdate($selfenrolinstanceobject->startdate), ]);
                } else if ($selfenrolinstanceobject->unrestrictedness == 'fromuntil') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolfromuntil', 'theme_boost_union_dhoch3',
                            ['name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate),
                                    'from' => userdate($selfenrolinstanceobject->startdate), ]);
                } else if ($selfenrolinstanceobject->unrestrictedness == 'sinceuntil') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolsinceuntil', 'theme_boost_union_dhoch3',
                            ['name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate),
                                    'since' => userdate($selfenrolinstanceobject->startdate), ]);
                }
            ...
            // Render template and add it to HTML code.
            $html .= $OUTPUT->render_from_template('theme_boost_union_dhoch3/course-hint-selfenrol', $templatecontext);
        }
    }
    ...
    if (get_config('theme_boost_union_dhoch3', 'showswitchedroleincourse') === THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES
            && is_role_switched($COURSE->id) ) {
        ...
        // Render template and add it to HTML code.
        $html .= $OUTPUT->render_from_template('theme_boost_union_dhoch3/course-hint-switchedrole', $templatecontext);
    }
 ...
 * @return string.
 */
function theme_boost_union_dhoch3_get_staticpage_link($page) {
    // Compose the URL object.
    $url = new moodle_url('/theme/boost_union_dhoch3/pages/'.$page.'.php');
 ...
 * @return string.
 */
function theme_boost_union_dhoch3_get_staticpage_pagetitle($page) {
    // Get the configured page title.
    $pagetitleconfig = format_string(get_config('theme_boost_union_dhoch3', $page.'pagetitle'), true,
    ...
    if ($pagetitleconfig) {
        ...
        return get_string($page.'pagetitledefault', 'theme_boost_union_dhoch3');
    }
}
 ...
 * @return boolean.
 */
function theme_boost_union_dhoch3_infobanner_is_shown_on_page($bannerno) {
    global $PAGE;

    // Get theme config.
    $config = get_config('theme_boost_union_dhoch3');

    // If the info banner is enabled.
    $enabledsettingname = 'infobanner'.$bannerno.'enabled';
    if ($config->{$enabledsettingname} == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        ...
        if (!empty($config->{$contentsettingname})) {
            ...
            if ($showonpage == true) {
                ...
                if ($config->{$modesettingname} == THEME_BOOST_UNION_DHOCH3_SETTING_INFOBANNERMODE_TIMEBASED) {
                    ...
                    if (get_user_preferences('theme_boost_union_dhoch3_infobanner'.$bannerno.'_dismissed') != true) {
                        return true;
                    }
                }
            }
 ...
 * @return boolean.
 */
function theme_boost_union_dhoch3_compare_order($a, $b) {
 ...
 */
function theme_boost_union_dhoch3_infobanner_reset_visibility($no) {
    global $DB;
    ...
    $params = ['name' => 'theme_boost_union_dhoch3_infobanner'.$no.'_dismissed', 'value' => '1'];
    ...
    foreach ($users as $user) {
        try {
            unset_user_preference('theme_boost_union_dhoch3_infobanner'.$no.'_dismissed', $user->userid);
 ...
 */
function theme_boost_union_dhoch3_get_random_loginbackgroundimage_number() {
    // Static variable.
    static $number = null;

    if ($number == null) {
        // Get all files for loginbackgroundimages.
        $files = theme_boost_union_dhoch3_get_loginbackgroundimage_files();
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_random_loginbackgroundimage_class() {
    // Get the static random number.
    $number = theme_boost_union_dhoch3_get_random_loginbackgroundimage_number();
 ...
 * @throws dml_exception
 */
function theme_boost_union_dhoch3_get_loginbackgroundimage_files() {
    ...
    if ($files == null) {
        ...
        $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'loginbackgroundimage',
                false, 'itemid', false);
    }
 ...
 * @return string|null
 */
function theme_boost_union_dhoch3_get_urloftilebackgroundimage($tileno) {
    ...
    if ($tileno < 0 || $tileno > THEME_BOOST_UNION_DHOCH3_SETTING_ADVERTISEMENTTILES_COUNT) {
        return null;
    }

    // Get the background image config for this tile.
    $bgconfig = get_config('theme_boost_union_dhoch3', 'tile'.$tileno.'backgroundimage');
    ...
    if (!empty($bgconfig)) {
        ...
        // Get all files from filearea.
        $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'tilebackgroundimage'.$tileno,
                false, 'itemid', false);
 ...
 * @return string|null
 */
function theme_boost_union_dhoch3_get_urlofslidebackgroundimage($slideno) {
    ...
    if ($slideno < 0 || $slideno > THEME_BOOST_UNION_DHOCH3_SETTING_SLIDES_COUNT) {
        return null;
    }

    // Get the background image config for this slide.
    $bgconfig = get_config('theme_boost_union_dhoch3', 'slide'.$slideno.'backgroundimage');
    ...
    if (!empty($bgconfig)) {
        ...
        // Get all files from filearea.
        $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'slidebackgroundimage'.$slideno,
                false, 'itemid', false);
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_loginbackgroundimage_scss() {
 ...
 * @throws dml_exception
 */
function theme_boost_union_dhoch3_get_loginbackgroundimage_text() {
    ...
    if ($number != null) {
        ...
        $lines = explode("\n", get_config('theme_boost_union_dhoch3', 'loginbackgroundimagetext'));
 ...
 * @throws dml_exception
 */
function theme_boost_union_dhoch3_get_additionalresources_templatecontext() {
    global $OUTPUT;
    ...
    if ($filesforcontext == null) {
        ...
        // Get all files from filearea.
        $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'additionalresources', false, 'itemid', false);

        // Iterate over the files and fill the templatecontext of the file list.
        $filesforcontext = [];
        foreach ($files as $af) {
            $urlpersistent = new moodle_url('/pluginfile.php/1/theme_boost_union_dhoch3/additionalresources/0/'.$af->get_filename());
            $urlrevisioned = new moodle_url('/pluginfile.php/1/theme_boost_union_dhoch3/additionalresources/'.theme_get_revision().
                    '/'.$af->get_filename());
 ...
 * @throws dml_exception
 */
function theme_boost_union_dhoch3_get_customfonts_templatecontext() {
    global $OUTPUT;
    ...
    if ($filesforcontext == null) {
        ...
        // Get all files from filearea.
        $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'customfonts', false, 'itemid', false);

        // Get the webfonts extensions list.
        $webfonts = theme_boost_union_dhoch3_get_webfonts_extensions();
        ...
        foreach ($files as $af) {
            ...
            $urlpersistent = new moodle_url('/pluginfile.php/1/theme_boost_union_dhoch3/customfonts/0/'.$filename);
 ...
 * @return array
 */
function theme_boost_union_dhoch3_get_webfonts_extensions() {
 ...
 * @throws coding_exception
 */
function theme_boost_union_dhoch3_register_webfonts_filetypes() {
    global $CFG;
 ...
 * @return string|null
 */
function theme_boost_union_dhoch3_get_emailbrandinghtmlpreview() {
    global $OUTPUT;

    // Get branding snippets.
    $htmlprefix = get_string('templateemailhtmlprefix', 'theme_boost_union_dhoch3');
    $htmlsuffix = get_string('templateemailhtmlsuffix', 'theme_boost_union_dhoch3');
    ...
    $mailtemplatecontext = ['body' => get_string('emailbrandinghtmldemobody', 'theme_boost_union_dhoch3')];
    ...
    $preview = $OUTPUT->render_from_template('theme_boost_union_dhoch3/emailpreview', $previewtemplatecontext);
 ...
 * @return string|null
 */
function theme_boost_union_dhoch3_get_emailbrandingtextpreview() {
    global $OUTPUT;

    // Get branding snippets.
    $textprefix = get_string('templateemailtextprefix', 'theme_boost_union_dhoch3');
    $textsuffix = get_string('templateemailtextsuffix', 'theme_boost_union_dhoch3');
    ...
    // Otherwise, compose mail text.
    $mailtemplatecontext = ['body' => get_string('emailbrandingtextdemobody', 'theme_boost_union_dhoch3')];
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_externaladminpage_title($pagename) {
    global $SITE;
    ...
    $title .= get_string('pluginname', 'theme_boost_union_dhoch3').': ';
    $title .= $pagename;
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_externaladminpage_heading() {
    global $SITE;
 ...
 * It's meant to be called by theme_boost_union_dhoch3_before_standard_html_head() only.
 * *
 * @throws coding_exception
 * @throws dml_exception
 * @throws moodle_exception
 */
function theme_boost_union_dhoch3_add_flavourcss_to_page() {
    global $CFG, $PAGE;
    ...
    $flavour = theme_boost_union_dhoch3_get_flavour_which_applies();
    if ($flavour != null) {
        // Build the flavour CSS file URL.
        $flavourcssurl = new moodle_url('/theme/boost_union_dhoch3/flavours/styles.php',
 ...
 * @return null | string
 */
function theme_boost_union_dhoch3_get_course_header_image_url() {
    global $PAGE;
    ...
    if ($courseimage) {
    ...
    } else if (get_config('theme_boost_union_dhoch3', 'courseheaderimagefallback')) {
        // Get the system context.
        $systemcontext = \context_system::instance();
        ...
        // Get all files from filearea.
        $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'courseheaderimagefallback',
            false, 'itemid', false);
 ...
 * @throws moodle_exception
 */
function theme_boost_union_dhoch3_set_mobilecss_url() {
    // Check if the admin has set any CSS code for the Mobile app.
    $csscode = get_config('theme_boost_union_dhoch3', 'mobilescss');
    if (!empty($csscode)) {
        ...
        $mobilescssurl = new moodle_url('/theme/boost_union_dhoch3/mobile/styles.php', ['rev' => time()]);
 ...
 */
function theme_boost_union_dhoch3_get_additional_regions($pageregions=[]) {
    $regions = [
 ...
 * @return array $regions
 */
function theme_boost_union_dhoch3_get_block_regions($layout) {

    // Get the admin setting for the layout.
    $regionsettings = get_config('theme_boost_union_dhoch3', 'blockregionsfor'.$layout);
 ...
 */
function theme_boost_union_dhoch3_check_mod_icons_cleanup() {
    global $CFG;

    // Get the modiconsenable setting.
    $modiconsenable = get_config('theme_boost_union_dhoch3', 'modiconsenable');

    // If modiconsenable was just enabled, return directly as everything is fine.
    if ($modiconsenable != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_NO) {
        return;
    }
 ...
 * @throws moodle_exception
 */
function theme_boost_union_dhoch3_place_mod_icons() {
    global $CFG, $DB;
    ...
    if ($modiconsenable != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        return;
    }
    ...
    // Get all files from filearea.
    $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'modicons', false, 'itemid', true);
 ...
 * @throws dml_exception
 */
function theme_boost_union_dhoch3_get_modicon_templatecontext () {
    global $DB;
    ...
    // Get all files from filearea.
    $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'modicons', false, 'filepath,filename', true);
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_scss_for_activity_icon_purpose($theme) {
    ...
    foreach ($installedactivities as $modname => $modinfo) {
        ...
        $activitypurpose = get_config('theme_boost_union_dhoch3', 'activitypurpose'.$modname);
        if ($activitypurpose && $activitypurpose != $defaultpurpose) {
            ...
            $scss .= '.block_recentlyaccesseditems .theme-boost-union-dhoch3-'.$modname.'.activityiconcontainer,';
            $scss .= '.block_timeline .theme-boost-union-dhoch3-mod_'.$modname.'.activityiconcontainer {';
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_scss_to_mark_external_links($theme) {
    global $CFG;
    ...
    $markexternallinksconfig = get_config('theme_boost_union_dhoch3', 'markexternallinks');
    if (isset($markexternallinksconfig) && $markexternallinksconfig == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {

        // Get the scope setting.
        $scope = get_config('theme_boost_union_dhoch3', 'markexternallinksscope');

        // Prepare the CSS selectors depending on the configured scope.
        switch ($scope) {
            case THEME_BOOST_UNION_DHOCH3_SETTING_MARKLINKS_COURSEMAIN:
                $topltrselector = 'body.dir-ltr.path-course-view #region-main';
                $toprtlselector = 'body.dir-rtl.path-course-view #region-main';
                break;
            case THEME_BOOST_UNION_DHOCH3_SETTING_MARKLINKS_WHOLEPAGE:
            default:
        ...
        if ($scope == THEME_BOOST_UNION_DHOCH3_SETTING_MARKLINKS_WHOLEPAGE) {
            ...
            $scss .= '#themeboostuniondhoch3slider a::before, #themeboostuniondhoch3slider a::after {
                display: none;
            }';
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_scss_to_mark_broken_links($theme) {
    // Initialize SCSS snippet.
    $scss = '';

    // If the corresponding setting is set to 'yes'.
    $markbrokenlinksconfig = get_config('theme_boost_union_dhoch3', 'markbrokenlinks');
    if (isset($markbrokenlinksconfig) && $markbrokenlinksconfig == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_scss_to_mark_mailto_links($theme) {
    // Initialize SCSS snippet.
    $scss = '';

    // If the corresponding setting is set to 'yes'.
    $markmailtolinksconfig = get_config('theme_boost_union_dhoch3', 'markmailtolinks');
    if (isset($markmailtolinksconfig) && $markmailtolinksconfig == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Get the scope setting.
        $scope = get_config('theme_boost_union_dhoch3', 'markmailtolinksscope');
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_scss_courseoverview_block($theme) {
    // Initialize SCSS snippet.
    $scss = '';
    ...
    $courseoverviewshowcourseimagesconfig = get_config('theme_boost_union_dhoch3', 'courseoverviewshowcourseimages');
    if (!isset($courseoverviewshowcourseimagesconfig)) {
        ...
        $showcourseimagescard = in_array(THEME_BOOST_UNION_DHOCH3_SETTING_COURSEOVERVIEW_SHOWCOURSEIMAGES_CARD, $showcourseimages);
        $showcourseimageslist = in_array(THEME_BOOST_UNION_DHOCH3_SETTING_COURSEOVERVIEW_SHOWCOURSEIMAGES_LIST, $showcourseimages);
        $showimagessummary = in_array(THEME_BOOST_UNION_DHOCH3_SETTING_COURSEOVERVIEW_SHOWCOURSEIMAGES_SUMMARY, $showcourseimages);
    }
    ...
    $courseoverviewshowcourseprogressconfig = get_config('theme_boost_union_dhoch3', 'courseoverviewshowcourseprogress');
    if (!isset($courseoverviewshowcourseprogressconfig) ||
            $courseoverviewshowcourseprogressconfig == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
 ...
 * @return array
 */
function theme_boost_union_dhoch3_get_loginpage_methods() {
    return [1 => 'local',
            2 => 'idp',
            3 => 'firsttimesignup',
            4 => 'guest',
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_scss_login_order($theme) {
    // Initialize SCSS snippet.
    $scss = '';
    ...
    foreach ($loginmethods as $key => $lm) {
        $setting = get_config('theme_boost_union_dhoch3', 'loginorder'.$lm);
        if ($setting != $key) {
            $unchanged = false;
        }
    }
    if ($unchanged == true) {
        ...
        $scss .= '#theme_boost_union_dhoch3-loginorder .theme_boost_union_dhoch3-loginmethod:first-of-type .login-divider { display: none; }';
    ...
    $scss .= '#theme_boost_union_dhoch3-loginorder { display: flex; flex-direction: column; }';
    ...
    foreach ($loginmethods as $lm) {
        ...
        $setting = get_config('theme_boost_union_dhoch3', 'loginorder'.$lm);
        $scss .= '#theme_boost_union_dhoch3-loginorder-'.$lm.' { order: '.$setting.'; }';
    ...
    $scss .= '#theme_boost_union_dhoch3-loginorder-'.$veryfirstmethodname.' .login-divider { display: none; }';
 ...
 */
function theme_boost_union_dhoch3_get_touchicons_for_ios() {
 ...
 * @return void
 */
function theme_boost_union_dhoch3_touchicons_for_ios_checkin() {
    // Create cache for touch icon files.
    $cache = cache::make('theme_boost_union_dhoch3', 'touchiconsios');
    ...
    $files = $fs->get_area_files($systemcontext->id, 'theme_boost_union_dhoch3', 'touchiconsios', false, 'itemid', false);
 ...
 */
function theme_boost_union_dhoch3_get_touchicons_for_ios_templatecontext() {
    // Create cache for touch icon files.
    $cache = cache::make('theme_boost_union_dhoch3', 'touchiconsios');

    // If the cache is completely empty, check the files in on-the-fly.
    if ($cache->get('checkedin') != true) {
        theme_boost_union_dhoch3_touchicons_for_ios_checkin();
    }
 ...
 * @return string
 */
function theme_boost_union_dhoch3_get_touchicons_html_for_page() {
    ...
    if (is_array($filelist) && count($filelist) > 0) {
        ...
        foreach ($filelist as $file) {
            ...
            if ($file->exists == true) {
                // Build the file URL.
                $fileurl = new moodle_url('/pluginfile.php/1/theme_boost_union_dhoch3/touchiconsios/' .
...
/**
 * Helper function to map Boost Union Dhoch3 settings ('yes'/'no') to corresponding string values ('true'/'false')
 * This is needed for Bootstrap which expects string boolean values.
 *
 * @param string $var Either 'yes' or 'no'
 */
function theme_boost_union_dhoch3_yesno_to_boolstring($var) {
    if ($var == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        return 'true';
    } else {
        return 'false';
    }
 ...
 */
function theme_boost_union_dhoch3_get_navbar_starredcoursespopover() {
    global $USER, $OUTPUT;
    ...
    $setting = get_config('theme_boost_union_dhoch3', 'shownavbarstarredcourses');
    if (!isset($setting) || $setting != THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        return '';
    }
    ...
    $html = $OUTPUT->render_from_template('theme_boost_union_dhoch3/popover-favourites', ['favourites' => $coursesfortemplate]);
 ...
 * -> function theme_boost_union_dhoch3_before_standard_html_head in lib.php (for releases up to Moodle 4.3)
 * -> class theme_boost_union_dhoch3\local\hook\output\before_standard_head_html_generation (for releases from Moodle 4.4 on).
 *
 ...
 */
function theme_boost_union_dhoch3_callbackimpl_before_standard_html(&$hook = null) {
    global $CFG, $PAGE;
    ...
    // If a theme other than Boost Union Dhoch3 or a child theme of it is active, return directly.
    // This is necessary as the callback is called regardless of the active theme.
    if ($PAGE->theme->name != 'boost_union_dhoch3' && !in_array('boost_union_dhoch3', $PAGE->theme->parents)) {
        if ($hook != null) {
            return;
        } else {
            return $html;
    ...
    theme_boost_union_dhoch3_add_flavourcss_to_page();

    // Add the touch icons to the page.
    $html .= theme_boost_union_dhoch3_get_touchicons_html_for_page();
