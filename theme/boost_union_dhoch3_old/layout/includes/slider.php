...
/**
 * Theme Boost Union Dhoch3 - slider layout include.
 *
...
for ($i = 1; $i <= THEME_BOOST_UNION_DHOCH3_SETTING_SLIDES_COUNT; $i++) {
    ...
    if (isset($config->{'slide' . $i . 'enabled'}) &&
            $config->{'slide' . $i . 'enabled'} == THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES) {
        // Get and set the slide's background image.
        $bgimage = theme_boost_union_dhoch3_get_urlofslidebackgroundimage($i);
        ...
        if ($config->{'slide'.$i.'linktarget'} == THEME_BOOST_UNION_DHOCH3_SETTING_LINKTARGET_NEWTAB) {
        ...
        switch ($config->{'slide'.$i.'contentstyle'}) {
            case THEME_BOOST_UNION_DHOCH3_SETTING_CONTENTSTYLE_LIGHT:
                $contentstyleclass = 'slide-light';
                break;
            case THEME_BOOST_UNION_DHOCH3_SETTING_CONTENTSTYLE_LIGHTSHADOW:
                $contentstyleclass = 'slide-lightshadow';
                break;
            case THEME_BOOST_UNION_DHOCH3_SETTING_CONTENTSTYLE_DARK:
                $contentstyleclass = 'slide-dark';
                break;
            case THEME_BOOST_UNION_DHOCH3_SETTING_CONTENTSTYLE_DARKSHADOW:
        ...
        switch ($config->{'slide'.$i.'linksource'}) {
            case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_LINKSOURCE_BOTH:
                $linkimage = true;
                $linktext = true;
                break;
            case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_LINKSOURCE_IMAGE:
                $linkimage = true;
                $linktext = false;
                break;
            case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_LINKSOURCE_TEXT:
                $linkimage = false;
                $linktext = true;
                break;
        }
...
if ($templatecontext['showslider'] == true) {
    ...
    switch ($config->{'sliderfrontpageposition'}) {
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_FRONTPAGEPOSITION_BEFOREBEFORE:
            ...
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_FRONTPAGEPOSITION_BEFOREAFTER:
            $templatecontext['sliderpositionbeforebefore'] = false;
            $templatecontext['sliderpositionbeforeafter'] = true;
            $templatecontext['sliderpositionafterbefore'] = false;
            $templatecontext['sliderpositionafterafter'] = false;
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_FRONTPAGEPOSITION_AFTERBEFORE:
            $templatecontext['sliderpositionbeforebefore'] = false;
            $templatecontext['sliderpositionbeforeafter'] = false;
            $templatecontext['sliderpositionafterbefore'] = true;
            $templatecontext['sliderpositionafterafter'] = false;
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_FRONTPAGEPOSITION_AFTERAFTER:
            $templatecontext['sliderpositionbeforebefore'] = false;
            $templatecontext['sliderpositionbeforeafter'] = false;
            $templatecontext['sliderpositionafterbefore'] = false;
    ...
    switch ($config->{'sliderarrownav'}) {
        case THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_YES:
            $generalslidersettings->showarrownav = true;
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SELECT_NO:
    ...
    switch ($config->{'slideranimation'}) {
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_ANIMATIONTYPE_SLIDE:
            $generalslidersettings->animation = 'slide';
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_ANIMATIONTYPE_FADE:
            $generalslidersettings->animation = 'slide carousel-fade';
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_ANIMATIONTYPE_NONE:
    ...
    switch ($config->{'sliderride'}) {
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_RIDE_ONPAGELOAD:
            $generalslidersettings->ride = 'carousel';
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_RIDE_AFTERINTERACTION:
            $generalslidersettings->ride = 'true';
            break;
        case THEME_BOOST_UNION_DHOCH3_SETTING_SLIDER_RIDE_NEVER:
    ...
    $generalslidersettings->keyboard = theme_boost_union_dhoch3_yesno_to_boolstring($config->{'sliderkeyboard'});

    // Getting and setting the slider's wrap setting.
    $generalslidersettings->wrap = theme_boost_union_dhoch3_yesno_to_boolstring($config->{'sliderwrap'});
    ...
    usort($slides, 'theme_boost_union_dhoch3_compare_order');
