...
/**
 * Theme Boost Union Dhoch3 - Flavours styles serving
 *
...
try {
    ...
    $flavour = $DB->get_record('theme_boost_union_dhoch3_flavours',
...
if ($flavour->look_backgroundimage != null) {
    ...
    $backgroundimageurl = moodle_url::make_pluginfile_url(
            context_system::instance()->id, 'theme_boost_union_dhoch3', 'flavours_look_backgroundimage', $flavourid,
