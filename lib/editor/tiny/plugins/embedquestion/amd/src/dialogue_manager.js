...
export const DialogManager = class {
    ...
    getEmbedCode = (e) => {
        ...
        const iframeDescription = "{Q{PHY_LE09/phy-le09-20-zwei-punktladungen|marks=0|44e713c70b36126653c1d6196888647897a0e096666b8f8faaae6bda079e7a0d}Q}";
        // const iframeDescription = document.getElementById('id_categoryidnumber').value;
     ...
     * @returns {Promise}
     */
    getEmbedCodeCall2 = (iframeDescription, questionIdnumber) => {
        return fetchMany([{
    ...
    getEmbedCodeCall = $.ajax({
        ...
        {
            index: 0,
            methodname: 'mod_book_embed_question', // Beispielmethode, anpassen!
            args: {
                courseid: 14,
                sesskey: 'c4qjDO9dfC',
                _qf__filter_embedquestion_form_embed_options_form: 1,
                mform_isexpanded_id_questionheader: 1,
                mform_isexpanded_id_attemptheader: 0,
                mform_isexpanded_id_reviewheader: 0,
                categoryidnumber: 'MA_LE02_28_rand-U2',
                questionidnumber: 'MA_LE02_28_5_rand',
                behaviour: '',
                maxmark: '',
                variant: '',
                correctness: '',
