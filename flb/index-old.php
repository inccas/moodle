...
<div class="container pb-5">
  ...
  <div class="form-row">
    ...
    <div class="col-md-5">
        ...
        <br>
        <a href="https://inccas-sol.net/flb-anmeldung/" target="_blank"><button type="button" id="submitButton" class="btn btn-primary btn-lg btn-block">Registrierung</button></a>
    </div>
  </div>
